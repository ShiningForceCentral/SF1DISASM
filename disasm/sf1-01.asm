...
sub_1CFE:
										...
										lsl.b   #4,d2
										clr.w   d0
										move.b  ($FFFFF803).w,d0
										lsr.b   #3,d0
										mulu.w  #$340,d0
										clr.w   d3
										move.b  ($FFFFF803).w,d3
										andi.b  #7,d3
										move.b  d3,d5
										lsl.b   #2,d3
										add.w   d3,d0
										clr.w   d3
										move.b  ($FFFFF802).w,d3
										andi.b  #$F8,d3
										lsl.w   #2,d3
										add.w   d3,d0
										lea     (unk_FF3000).l,a2
...
loc_31F6:
										...
										cmpi.b  #1,($FFFF9C02).w
										bne.s   return_327C
										move.b  ($FFFFF807).w,d0
										move.b  ($FFFF9C01).w,d1
										move.b  ($FFFF9C03).w,d2
										clr.b   ($FFFF9C02).w
										movem.w d0-d2,-(sp)
										clr.l   (dword_FF0EF6).l
										jsr     (sub_340).l
										clr.l   (dword_FF0EF6).l
										movem.w (sp)+,d0-d2
										move.b  d1,($FFFF9C01).w
										move.b  d2,($FFFF9C03).w
										move.b  #1,($FFFF9C02).w
										bra.w   loc_31F6
return_327C:
...
sub_3852:
										...
										bsr.w   sub_288
										bsr.w   sub_228
										move.w  #$14,($FFFFB56A).w
										move.w  #$14,($FFFFB58A).w
										move.b  #1,($FFFFB5AC).w
...
sub_3B16:
										...
										clr.l   d0
										move.b  ($FFFF9C00).w,d0
										move.l  d0,($FFFFF900).w
										move.w  #$4A,($FFFFC0BE).w 
										move.w  #$30C,d0
										trap    #8
										trap    #7
										trap    #0
										...
										move.b  #3,($FFFF9C01).w
										clr.b   ($FFFF9C02).w
										move.b  #$FF,($FFFF9C03).w
										moveq   #$24,d0 
										bsr.w   sub_3054
										moveq   #$27,d0 
										bsr.w   sub_3062
										move.w  #$80,($FFFF9C88).w 
										rts
...
loc_5086:
										...
										adda.w  d0,a0
										move.b  (a0)+,($FFFF9C00).w
										move.b  (a0)+,($FFFF9C01).w
										move.b  (a0)+,($FFFF9C03).w
										move.b  (a0)+,($FFFF9C02).w
										clr.w   d1
										move.b  (a0)+,d1
										bmi.w   loc_50CC
										lsl.w   #3,d1
...
loc_5ABE:
										...
										bra.w   loc_5A26
loc_5AD8:
										move.b  d1,($FFFFB51C).w
										clr.w   d0
										jsr     j_GetForceMemberMP
										move.w  d1,-(sp)
										move.b  ($FFFFB51C).w,d1
										jsr     sub_202A4
										move.w  (sp)+,d1
										cmp.w   d1,d2
										ble.s   loc_5B00
...
loc_5B00:
										...
										move.w  d1,-(sp)
										andi.w  #$3F,d1 
										move.w  d1,($FFFFF846).w
										move.w  (sp)+,d1
										lsr.w   #6,d1
										ext.l   d1
										addq.l  #1,d1
										move.l  d1,($FFFFF900).w
										trap    #5
										move.w  #$1B5,d0
										trap    #8
										trap    #0
...
loc_5B92:
										...
										tst.w   d0
										bmi.s   loc_5B58
										move.w  d0,($FFFFB7C4).w
										jsr     sub_200E4
										clr.w   d1
										move.b  ($FFFFB528).w,d1
										move.b  (a0,d1.w),d1
										move.b  d0,($FFFFF001).w
										jsr     sub_200E4
										move.b  ($FFFFB528).w,d0
										move.b  (a0,d0.w),d0
										andi.w  #$3F,d0 
										move.w  d0,($FFFFF844).w
										cmpi.b  #$27,d0 
										bne.w   loc_5C30
										cmpi.b  #8,($FFFF9C00).w
										bne.w   loc_5C30
...
loc_5C30:
										...
										bsr.w   sub_73D4
										jsr     sub_202B8
										move.w  ($FFFFA9E2).w,($FFFFF844).w
										move.l  ($FFFFA9E6).w,($FFFFF900).w
										move.w  ($FFFFA9E0).w,d0
										trap    #8
										bsr.w   sub_5CE6
										trap    #6
										rts
...
sub_5CFE:
										...
										clr.w   d1
										move.b  ($FFFFB528).w,d1
										move.w  d1,($FFFFB7C6).w
										move.b  (a0,d1.w),d1
										move.w  d1,-(sp)
										andi.w  #$3F,d1 
										move.w  d1,($FFFFF844).w
										move.w  (sp)+,d1
										btst    #7,d1
										beq.s   loc_5D5C
										jsr     sub_2026C
...
loc_5DA0:
										...
										clr.w   d1
										move.b  ($FFFFB528).w,d1
										move.w  d1,($FFFFB7CA).w
										move.w  ($FFFFB7C4).w,d0
										move.w  ($FFFFB7C6).w,d1
										jsr     sub_200E4
										move.b  (a0,d1.w),d1
										move.w  ($FFFFB7C8).w,d0
										jsr     sub_2024C
										bcc.w   loc_5E8C
										move.w  ($FFFFB7C8).w,d0
										jsr     sub_200E4
										move.w  ($FFFFB7CA).w,d1
										move.b  (a0,d1.w),d1
										move.w  d1,-(sp)
										andi.w  #$3F,d1 
										move.w  d1,($FFFFF844).w
...
sub_617C:
										move.w  #$C07E,($FFFFC0B6).w
										jsr     sub_20038
										move.w  ($FFFFCB82).w,d7
										subq.w  #1,d7
										move.w  d7,-(sp)
										movem.l d7-a1,-(sp)
										lea     ($FFFFCB84).w,a0
...
loc_6B38:
										clr.w   d1
										clr.w   d2
										move.b  ($FFFF9C4A).w,d1
										move.b  ($FFFF9C4B).w,d2
loc_6B44:
										jsr     sub_80A8
										move.w  d2,d3
...
loc_6B9A:
										...
										move.b  (a0,d1.w),d1
										addi.w  #$45,d1 
										move.w  d1,($FFFFC0BE).w
										movea.l (sp)+,a0
										move.w  (sp)+,d1
										move.w  (sp)+,d0
										clr.w   d2
										move.b  ($FFFFB4D6).w,d2
										bsr.w   sub_6894
										move.w  (sp)+,d0
										cmpi.w  #1,d0
										bne.s   loc_6BF6
...
loc_77C0:
										...
										beq.w   loc_7898
										clr.w   d7
										move.b  ($FFFFB4C5).w,d7
										move.w  d7,($FFFFF844).w
										cmpi.b  #$3F,d3 
										bgt.w   loc_78B0
										move.w  d3,($FFFFF846).w
										jsr     (sub_304).l
										clr.w   ($FFFFC0BE).w
										movem.w d1,-(sp)
										move.b  ($FFFFB4C5).w,d0
										move.w  ($FFFFF846).w,d1
										jsr     sub_2025C
										movem.w (sp)+,d1
										bcs.w   loc_7872
										trap    #0

...
p_EffectGraphics:   dc.l EffectGraphics
...
loc_1240D2:         move.w  (a6)+,d0
										move.w  d0,($FFFFBC72).w
										jsr     sub_20310
										move.w  d1,($FFFFBC6A).w
										move.w  d2,($FFFFBC6C).w
										move.w  d3,($FFFFBC82).w
										move.w  (a6)+,d0
										move.w  d0,($FFFFBC74).w
										jsr     sub_20310
										move.w  d1,($FFFFBC6E).w
										move.w  d2,($FFFFBC70).w
										move.w  d3,($FFFFBC86).w
										jsr     sub_20274
										move.w  d2,($FFFFBC76).w
										move.w  d3,($FFFFBC78).w
										move.w  #$64,($FFFFBC7A).w 
										move.w  #$65,($FFFFBC7E).w 
										trap    #0
										dc.w $FD
										jsr     (sub_22C).l
...
loc_1241F8:         clr.l   (a0)+
										...
										move.w  #2,d1
										jsr     (sub_274).w
										move.w  ($FFFFBC72).w,d0
										bpl.s   loc_124220
										move.w  ($FFFFBC74).w,d0
...
loc_12426E:         jsr     sub_126380
										...
										move.w  #2,d1
										jsr     (sub_294).l
										move.b  #$30,($FFFFBC8A).w 
										move.b  #$20,($FFFFBC8B).w 
										move.b  #$40,($FFFFBC8C).w 
										move.b  #$20,($FFFFBC8D).w 
										move.w  ($FFFFBC72).w,d0
										cmpi.w  #$FFFF,d0
										beq.s   loc_12430C
										clr.w   d1
										move.w  ($FFFFBC6A).w,d0
										bsr.w   sub_1262A8
										lea     (loc_5000).w,a1
										move.w  #$C00,d0
										move.w  #2,d1
										...
										jsr     (sub_274).w
										move.w  ($FFFFBC6A).w,d0
										move.w  ($FFFFBC6C).w,d1
										bsr.w   sub_126284
										bsr.w   sub_1244CA
loc_12430C:         move.w  ($FFFFBC74).w,d0
										cmpi.w  #$FFFF,d0
										beq.w   loc_1243CE
										clr.w   d1
										move.w  ($FFFFBC6E).w,d0
										bsr.w   sub_126326
										lea     (unk_FF3000).l,a0
										lea     (sub_8000).l,a1
										move.w  #$900,d0
										...
										jsr     (sub_274).w
										move.w  ($FFFFBC6E).w,d0
										move.w  ($FFFFBC70).w,d1
										bsr.w   sub_1262CE
										bsr.w   sub_124516
										move.w  ($FFFFBC76).w,d0
										cmpi.w  #$FFFF,d0
										beq.s   loc_1243CE
										bsr.w   sub_12634C
										move.w  ($FFFFBC86).w,d0
										movea.l (off_144004).l,a0
										lsl.w   #2,d0
										movea.l (a0,d0.w),a0
										addq.l  #4,a0
										move.w  (a0)+,($FFFFB544).w
										move.w  ($FFFFB544).w,($FFFFB540).w
										move.w  (a0)+,($FFFFB546).w
										move.w  ($FFFFB546).w,($FFFFB542).w
										lea     (word_FF5000).l,a0
										move.b  ($FFFFB540).w,d0
										andi.w  #$F,d0
										ror.w   #5,d0
										adda.w  d0,a0
										lea     ($A400).l,a1
										...
										move.w  #2,d1
										jsr     (sub_274).l
										move.w  ($FFFFBC78).w,d0
										bsr.w   sub_12630C
loc_1243CE:         move.w  ($FFFFBC74).w,d0
										cmpi.w  #$FFFF,d0
										beq.s   loc_1243DE
										jsr     sub_8014
loc_1243DE:         move.w  ($FFFFBC72).w,d0
										cmpi.w  #$FFFF,d0
										beq.s   loc_1243EE
										jsr     sub_8018
loc_1243EE:         lea     unk_12570A(pc), a0
										...
										moveq   #$20,d6 
										jsr     (sub_284).w
										move.w  ($FFFFBC7A).w,($FFFFBC7C).w
										move.w  ($FFFFBC7E).w,($FFFFBC80).w
...
sub_1244CA:
										...
										movem.w (sp)+,d1
										beq.s   loc_1244EC
										move.w  ($FFFFBC7A).w,d0
										add.w   d0,d0
										move.w  d0,($FFFFBC7A).w
loc_1244EC:
...
sub_124516:
										...
										movem.w (sp)+,d1
										beq.s   loc_124538
										move.w  ($FFFFBC7E).w,d0
										add.w   d0,d0
										move.w  d0,($FFFFBC7E).w
loc_124538:
...
loc_1245E4:         or.w    d3,d5
										...
										dbf     d7,loc_124568
										rts
loc_1245F2:         move.b  #1,($FFFFB5BB).w
										move.w  (a6)+,d0
										cmpi.b  #$FF,d0
										beq.w   loc_1246FE
										movea.l (off_144004).l,a0
...
loc_12465C:         move.b  (a0)+,d0
										...
										cmpi.b  #1,($FFFFB5BB).w
										bne.s   loc_124672
										move.l  (a0)+,($FFFFB540).w
loc_124672:         movem.l a0,-(sp)
										movem.w d3-d7,-(sp)
										btst    #0,($FFFFB5BB).w
										beq.s   loc_1246BE
										bsr.w   sub_1253CC
										cmpi.w  #$FFFF,($FFFFBC76).w
										beq.s   loc_1246BC
										clr.w   d0
										move.b  ($FFFFB540).w,d0
										andi.w  #7,d0
...
loc_1246FE:         move.w  (a6)+,d0
										bra.w   loc_12647E
loc_124704:         move.b  #2,($FFFFB5BB).w
										move.w  (a6)+,d0
										cmpi.b  #$FF,d0
										beq.s   loc_1246FE
...
loc_12471C:         clr.w   d0
										...
										clr.w   d0
										bset    d1,d0
loc_12472A:         tst.b   (byte_FF0E97).l
										bne.s   loc_12473C
										jsr     (sub_240).l
										dbf     d0,loc_12472A
loc_12473C:         trap    #0
...
loc_1249DC:         move.w  ($FFFFBC74).w,d0
										move.w  (a6)+,d1
										move.w  d1,-(sp)
										jsr     sub_201F0
										move.w  (a6)+,d1
...
loc_124A1A:         cmpi.w  #$FC19,d7
										...
										trap    #0
										dc.w $4E
										move.b  (byte_FF0EB9).l,d0
										move.w  d0,-(sp)
										move.b  #1,(byte_FF0EB9).l
										move.b  #7,(byte_FF0EB7).l
										clr.b   (byte_FF0EBA).l
										move.b  #4,(byte_FF0EBC).l
										move.b  (byte_FF0EB9).l,(byte_FF0EBB).l
										move.w  (dword_FF0100).l,($FFFFB7C4).w
										move.w  (dword_FF0500).l,($FFFFB7C6).w
										move.w  (dword_FF0500+2).l,($FFFFB7C8).w
										moveq   #$C,d0
loc_124A70:         move.w  d0,-(sp)
										...
										bsr.w   sub_124C58
return_124B20:      rts
loc_124B22:         move.w  ($FFFFBC74).w,d0
										move.w  d0,(a5)+
										move.w  #$FFFF,(a5)
										bsr.w   sub_124D1E
										movem.w d0-d2,-(sp)
...
loc_124B4C:         trap    #0
										dc.w $65
										rts
loc_124B52:         move.w  ($FFFFBC72).w,d0
										move.w  (a6)+,d1
										move.w  d1,-(sp)
										jsr     sub_201F0
										move.w  (a6)+,d1
...
loc_124B90:         cmpi.w  #$FC19,d7
										...
										move.b  #7,(byte_FF0EB7).l
										clr.b   (byte_FF0EBA).l
										move.b  #8,(byte_FF0EBC).l
										move.b  #1,(byte_FF0EBB).l
										move.b  (byte_FF0EB9).l,(byte_FF0EBB).l
										moveq   #$C,d0
loc_124BD6:         move.w  d0,-(sp)
										...
										bsr.w   sub_124D46
return_124C3A:      rts
loc_124C3C:         move.w  ($FFFFBC72).w,d0
										move.w  d0,(a5)+
										move.w  #$FFFF,(a5)
										bsr.w   sub_124DB4
										moveq   #$48,d3 
...
sub_124DEE:
										...
										bsr.w   sub_124754
										move.b  #$FF,($FFFFB5BD).w
										rts

	; End of function sub_124DEE

loc_124DFA:         tst.b   ($FFFFB5BC).w
										bne.s   loc_124DFA
										rts
loc_124E02:         move.w  (a6)+,d0
										move.w  (a6)+,($FFFFF844).w
										move.w  (a6)+,($FFFFF846).w
										move.l  (a6)+,($FFFFF900).w
										move.w  d0,-(sp)
										clr.w   ($FFFFC0BE).w
										jsr     (sub_304).l
										move.w  (sp)+,d0
...
loc_125264:
										...
										move.w  #$400,($FFFFB544).w
										move.w  #$7F7F,($FFFFB546).w
loc_125270:
...
loc_125414:
										...
										move.l  d0,(a0)+
										movem.w (sp)+,d0-d1
										move.b  ($FFFFB542).w,d2
										ext.w   d2
										add.w   d2,d0
										move.b  ($FFFFB543).w,d2
										ext.w   d2
										add.w   d2,d1
										move.b  ($FFFFB541).w,d2
										bsr.w   sub_12538A
										jsr     (sub_320).l
										rts
...
loc_1256F4:
										...
										move.w  ($FFFFB7C6).w,(a0)
										add.w   d6,(a0)+
										move.w  ($FFFFB7C8).w,(a0)
										add.w   d6,(a0)+
										dbf     d7,loc_1256F4
										movea.l (sp)+,a0
										move.w  (sp)+,d7
...
loc_126C30:         movem.l d3,-(sp)
										...
										moveq   #6,d2
										bra.w   loc_12668A
dword_126C8E:       dc.l $E260EEE
										dc.l $AAA0666
										dc.w $820
loc_126C98:         bsr.w   sub_126826
										lea     dword_126C8E(pc), a0
										lea     (word_FF002C).l,a1
										move.l  (a0)+,(a1)+
										move.l  (a0)+,(a1)+
										move.w  (a0)+,(a1)+
...
unk_126EF0:         dc.b  $C
										...
										dc.b  $E
										dc.b $EE 
loc_126EFA:         lea     unk_126EF0(pc), a0
										lea     (word_FF002C).l,a1
										move.l  (a0)+,(a1)+
										move.l  (a0)+,(a1)+
										move.w  (a0)+,(a1)+
...
unk_1270F4:         dc.b  $C
										...
										dc.b  $A
										dc.b $40 
loc_1270FE:         lea     unk_1270F4(pc), a0
										lea     (word_FF002C).l,a1
										move.l  (a0)+,(a1)+
										move.l  (a0)+,(a1)+
										move.w  (a0)+,(a1)+
										jsr     (sub_224).l
										move.b  #$14,($FFFFB5BF).w
loc_12711A:         trap    #0
										dc.w $69
...
loc_12715C:         trap    #0
										dc.w $69
										bsr.w   sub_1267AC
										lea     unk_1270F4(pc), a0
										lea     (word_FF002C).l,a1
										move.l  (a0)+,(a1)+
										move.l  (a0)+,(a1)+
										move.w  (a0)+,(a1)+
										jsr     (sub_224).l
										move.b  #$15,($FFFFB5BF).w
										bra.s   loc_12711A
unk_127182:         dc.b  $C
										dc.b $EE 
										dc.b   8
...
loc_127286:         clr.w   (RAM_START).l
										...
										move.b  ($FFFFB5BE).w,d6
										andi.w  #7,d6
										cmpi.b  #2,d6
										bgt.s   loc_1272E0
										addq.w  #4,d7
loc_1272E0:         tst.b   ($FFFFB5BD).w
										bpl.s   loc_1272EA
										move.w  #$120,d3
...
loc_12739C:         cmpi.b  #$FF,($FFFFB5BD).w
										beq.s   loc_1273AC
										bsr.w   loc_1273E0
										bra.w   loc_1273D8
loc_1273AC:         lea     ($FFFFB5E4).w,a0
										clr.w   d0
										move.b  ($FFFFB5BE).w,d7
										andi.w  #7,d7
										subq.w  #1,d7
...
loc_127A7C:         movem.l d0/d7-a0,-(sp)
										...
										bgt.s   loc_127AB2
										move.w  d7,4(a0)
loc_127AB2:         move.b  ($FFFFB5BE).w,d2
										andi.b  #7,d2
										cmpi.b  #1,d2
										bne.s   loc_127AC4
										moveq   #1,d2
...
loc_127DBC:         cmpi.b  #$FF,($FFFFB5BD).w
										beq.s   loc_127DCC
										bsr.w   loc_127DEE
										bra.w   loc_127DE8
loc_127DCC:         lea     ($FFFFB5C4).w,a0
										clr.w   d0
										moveq   #$13,d7
...
loc_127F54:         cmpi.b  #$FF,($FFFFB5BD).w
										beq.s   loc_127F64
										bsr.w   sub_127F86
										bra.w   loc_127F80
loc_127F64:         lea     ($FFFFB5C4).w,a0
										clr.w   d0
										moveq   #$13,d7
...
loc_127FD4:         movem.l d0/d7-a0,-(sp)
										...
										bne.s   loc_128042
										addq.w  #1,d7
loc_128042:         cmpi.b  #2,($FFFFB5BE).w
										bgt.s   loc_128058
										cmpi.w  #$28,d7 
										bne.s   loc_128058
										movem.l (sp)+,d7
...
loc_12809A:         movem.l (sp)+,d0/d7-a0
										...
										bne.s   loc_1280BE
										move.w  #$EA0,(RAM_START).l
loc_1280BE:         cmpi.b  #$FF,($FFFFB5BD).w
										beq.s   loc_1280CE
										bsr.w   loc_1280F0
										bra.w   loc_1280EA
loc_1280CE:         lea     ($FFFFB5C4).w,a0
										clr.w   d0
										moveq   #$13,d7
...
loc_12826E:         cmpi.b  #$FF,($FFFFB5BD).w
										bne.s   loc_128298
										lea     ($FFFFB658).w,a0
										tst.w   (a0)
										beq.w   loc_12828C
										...
										ble.w   loc_128298
										clr.w   (a0)
loc_12828C:         clr.b   ($FFFFB5BC).w
										bsr.w   sub_126704
										bsr.w   sub_126982
loc_128298:         jsr     (sub_224).w
										rts
...
loc_128560:         moveq   #1,d1
										...
										sub.w   d2,d3
										eori.w  #1,d7
loc_12856E:         move.b  ($FFFFB5BE).w,d2
										andi.w  #7,d2
										cmpi.w  #2,d2
										bne.s   loc_12857E
										addq.w  #8,d7
...
sub_128618:
										...
										lsr.w   #1,d7
										bne.w   loc_12865A
										move.w  ($FFFFB5C0).w,d0
										move.w  ($FFFFB5C2).w,d1
										moveq   #$30,d6 
										jsr     (sub_2E0).l
										sub.w   d7,d0
										addi.w  #$18,d0
...
loc_1287FC:         movem.l (sp)+,d0/d7-a0
										...
										addq.w  #8,a0
										dbf     d7,loc_1287A6
loc_128808:         cmpi.w  #$1E,($FFFFB610).w
										bge.s   loc_128818
										bsr.w   loc_12883E
										bra.w   loc_128838
loc_128818:         cmpi.b  #$FF,($FFFFB5BD).w
										bne.s   loc_128838
										lea     ($FFFFB5C4).w,a0
										clr.w   d0
										moveq   #$13,d7
...
unk_1288A0:         dc.b $FC 
										...
										dc.b   0
										dc.b   0
loc_1288B4:         cmpi.w  #$3C,($FFFFB5C0).w 
										beq.w   return_12890E
										moveq   #$20,d0 
										moveq   #1,d1
										moveq   #5,d2
...
loc_1288D4:         move.w  #$98,d3 
										move.w  #$5E,d4 
loc_1288DC:         addq.w  #1,($FFFFB5C0).w
										move.w  ($FFFFB5C0).w,d7
										cmpi.w  #$3C,d7 
										bne.s   loc_1288FA
										move.w  #$180,d4
										clr.b   ($FFFFB5BC).w
...
loc_128A10:         or.w    (a0),d0
										...
										clr.b   ($FFFFB5BC).w
										bsr.w   sub_126982
loc_128A24:         jsr     (sub_224).w
										bne.s   return_128A36
										jsr     (sub_288).l
										jsr     (sub_260).l
return_128A36:      rts
loc_128A38:         cmpi.b  #$82,($FFFFB5BE).w
										beq.w   loc_128988
										cmpi.w  #$23,($FFFFB5C0).w 
										beq.w   return_128AF2
										moveq   #$20,d0 
										moveq   #1,d1
										moveq   #2,d2
										move.b  ($FFFFB5BE).w,d3
										move.b  d3,d4
										andi.b  #7,d3
										tst.b   d4
										bmi.s   loc_128A84
...
loc_128AA8:         lea     off_128B1C(pc), a0
										...
										move.w  #$64,d3 
										move.w  #$5B,d4 
loc_128AB6:         addq.w  #1,($FFFFB5C0).w
										move.w  ($FFFFB5C0).w,d7
										cmpi.w  #$23,d7 
										bne.s   loc_128AD0
										move.w  #$180,d4
...
unk_128C23:         dc.b   0
										...
										dc.b  $F
										dc.b   1
loc_128D04:         cmpi.w  #$1E,($FFFFB5C0).w
										bge.w   loc_128D78
										moveq   #$20,d0 
										moveq   #1,d1
										moveq   #7,d2
...
unk_128D9E:         dc.b $E8 
										...
										dc.b   7
										dc.b   3
loc_128E16:         cmpi.w  #$1E,($FFFFB5C0).w
										beq.w   loc_128E84
										moveq   #$20,d0 
										moveq   #1,d1
										moveq   #2,d2
...
unk_128EAA:         dc.b $F0 
										...
										dc.b   0
										dc.b   1
loc_128F04:         cmpi.w  #$1E,($FFFFB5C0).w
										beq.w   loc_128F72
										moveq   #$20,d0 
										moveq   #1,d1
										moveq   #2,d2
...
loc_128FC2:         move.w  #1,($FFFFB7C6).w
										bsr.w   sub_12BF92
										add.w   d0,d0
...
loc_12A4BA:         moveq   #$2B,d0 
										jsr     (sub_390).l
										rts
loc_12A4C4:         tst.b   ($FFFFC1CA).w
										beq.s   loc_12A4DA
										cmpi.b  #$70,(byte_FF0E97).l 
										bne.s   loc_12A4DA
										moveq   #$FFFFFFFF,d2
										bsr.w   sub_12C1BA
...
loc_12AB9E:         clr.w   d2
										...
										rts
										rts
loc_12ABCC:         move.w  #1,($FFFFB7C6).w
										bsr.w   sub_12BF92
										add.w   d0,d0
...
loc_12ADF2:         trap    #5
										...
										move.w  #$86,d3 
										bsr.w   sub_12C09E
loc_12AE18:         move.w  #2,($FFFFB7C6).w
										move.w  #$80,d2 
										bsr.w   sub_12BFB6
										tst.w   d0
										blt.s   loc_12AE3A
...
loc_12B038:         moveq   #$30,d0 
										...
										jsr     sub_80AC
										bra.s   loc_12B074
loc_12B05C:         move.b  #4,($FFFF9C01).w
										moveq   #$26,d1 
										moveq   #$10,d2
										moveq   #9,d3
										moveq   #7,d4
										...
										moveq   #0,d6
										jsr     sub_80AC
loc_12B074:         move.b  #$FF,($FFFF9C03).w
										jsr     sub_20400
										jsr     sub_203A0
										trap    #0
										dc.w $4E
...
loc_12B398:         moveq   #$23,d0 
										...
										moveq   #$1E,d0
										jsr     (sub_244).l
loc_12B44A:         jsr     (sub_240).l
										subq.w  #1,($FFFFB7C4).w
										bne.s   loc_12B44A
										moveq   #$3C,d0 
										jsr     (sub_244).l
										move.b  ($FFFF9C51).w,d0
										lsl.w   #2,d0
										andi.w  #$C0,d0 
										or.b    d0,($FFFF9C51).w
										bra.w   loc_12BF66
...
loc_12B9C8:         trap    #0
										dc.w $FD
loc_12B9CC:         jsr     (sub_240).l
										subq.w  #1,($FFFFB7C4).w
										bne.s   loc_12B9CC
										move.w  #$B4,d0 
										jsr     (sub_244).l
										move.w  #$1E,($FFFFB7C4).w
										trap    #0
										dc.w 6
										moveq   #$29,d0 
										jsr     sub_802C
...
loc_1300C4:         move.l  #$EEE0EEE,(a0)+
										...
										jsr     (sub_214).l
										bsr.w   sub_13162E
										movea.l (off_C0030).l,a0
										lea     (dword_FF0080).l,a1
										move.w  #$20,d7 
										jsr     (sub_2FC).l
										movea.l (off_C0034).l,a0
										lea     (unk_2000).w,a1
										move.w  #$1000,d0
										move.w  #2,d1
										jsr     (sub_294).l
...
loc_1301F4:         move.l  #$EEE0EEE,(a0)+
										...
										bsr.w   sub_13162E
										bsr.w   sub_1316A8
										movea.l (off_C003C).l,a0
										lea     (unk_2000).w,a1
										move.w  #$C00,d0
										move.w  #2,d1
										jsr     (sub_294).l
										movea.l (off_C0040).l,a0
										lea     (loc_3800).w,a1
										move.w  #$C00,d0
										move.w  #2,d1
										jsr     (sub_294).l
										...
										bsr.w   sub_13162E
										bsr.w   sub_1316D8
										movea.l (off_C0048).l,a0
										lea     (unk_2000).w,a1
										move.w  #$C00,d0
										move.w  #2,d1
										jsr     (sub_294).l
										movea.l (off_C004C).l,a0
										lea     (loc_3800).w,a1
										move.w  #$C00,d0
										move.w  #2,d1
										jsr     (sub_294).l
										...
										move.w  #2,d1
										jsr     (sub_294).l
										movea.l (off_C0054).l,a0
										lea     ($7800).w,a1
										move.w  #$C00,d0
										move.w  #2,d1
										jsr     (sub_294).l
										movea.l (off_C0044).l,a0
										lea     (dword_FF0080).l,a1
										move.w  #$20,d7 
										jsr     (sub_2FC).l
										trap    #5
										move.b  #2,($FFFFF804).w
										move.w  #$1E,($FFFFB7C6).w
										clr.w   ($FFFFB7C4).w
										jsr     (sub_210).l
										...
										move.w  #$5A,d0 
										bsr.w   loc_1304FE
										move.w  #$280,($FFFFB7C4).w
loc_1303C4:         jsr     (sub_214).l
										bsr.w   sub_13162E
										...
										move.w  #2,d1
										jsr     (sub_274).l
										movea.l (off_C0058).l,a0
										lea     (dword_FF0080).l,a1
										move.w  #$20,d7 
										jsr     (sub_2FC).l
										movea.l (off_C005C).l,a0
										lea     (unk_2000).w,a1
										move.w  #$1000,d0
										move.w  #2,d1
										jsr     (sub_294).l
...
unk_130464:         dc.b   0
										...
										jsr     (sub_214).l
										rts
loc_1304FE:         btst    #7,(byte_FF0E97).l
										beq.s   loc_13052A
										clr.l   (dword_FF0EF6).l
										trap    #0
										dc.w $FD
										...
										trap    #0
										dc.w $23
										move.w  #$50,($FFFFB7C4).w 
										bra.w   loc_1303C4
loc_13052A:         jsr     (sub_240).l
										dbf     d0,loc_1304FE
										rts
loc_130536:         btst    #7,(byte_FF0E97).l
										beq.s   loc_130556
										clr.l   (dword_FF0EF6).l
										trap    #0
										dc.w $FD
...
off_130580:         dc.l unk_130740
										...
										dc.b  $C
										dc.b $40 
loc_1305B4:         subq.w  #1,($FFFFB7C6).w
										bne.s   return_1305F6
										move.w  #5,($FFFFB7C6).w
loc_1305C0:         move.w  ($FFFFB7C4).w,d0
										move.b  byte_130562(pc,d0.w),d0
										bpl.s   loc_1305D2
										subi.w  #$E,($FFFFB7C4).w
										bra.s   loc_1305C0
loc_1305D2:         addq.w  #1,($FFFFB7C4).w
										lsl.w   #2,d0
...
off_130612:         dc.l unk_13100A
										...
										dc.b $15
										dc.b $28 
loc_13062A:         subq.w  #1,($FFFFB7C6).w
										bne.s   return_13066C
										move.w  #$F,($FFFFB7C6).w
loc_130636:         move.w  ($FFFFB7C4).w,d0
										move.b  byte_1305F8(pc,d0.w),d0
										bpl.s   loc_130648
										subi.w  #$10,($FFFFB7C4).w
										bra.s   loc_130636
loc_130648:         addq.w  #1,($FFFFB7C4).w
										lsl.w   #2,d0
...
loc_1306B0:         move.l  4(a0),(a0)+
										...
										subq.w  #1,($FFFFB7C6).w
										bne.s   return_130704
										move.w  #$19,($FFFFB7C6).w
loc_1306D0:         move.w  ($FFFFB7C4).w,d0
										move.b  byte_13068C(pc,d0.w),d0
										bpl.s   loc_1306E0
										subq.w  #4,($FFFFB7C4).w
										bra.s   loc_1306D0
loc_1306E0:         addq.w  #1,($FFFFB7C4).w
										movea.l (off_C0044).l,a0
										lsl.w   #5,d0
										adda.w  d0,a0
										lea     (RAM_START).l,a1
										...
										jsr     (sub_224).l
return_130704:      rts
loc_130706:         subq.w  #1,($FFFFB7C4).w
										move.w  ($FFFFB7C4).w,d0
										bne.s   loc_130722
										jsr     sub_80DC
										bsr.w   sub_13066E
										move.w  #$28,($FFFFB7C4).w 
										rts

...
loc_1240D2:     move.w  (a6)+,d0
		...
		move.w  (a6)+,d0
		move.w  d0,((word_FFBC74-$1000000)).w
		jsr     sub_20310
		move.w  d1,((unk_FFBC6E-$1000000)).w
		move.w  d2,((unk_FFBC70-$1000000)).w
		move.w  d3,((unk_FFBC86-$1000000)).w
		jsr     sub_20274
		move.w  d2,((unk_FFBC76-$1000000)).w
...
loc_1241F8:     clr.l   (a0)+
		...
		bpl.s   loc_124220
		move.w  ((word_FFBC74-$1000000)).w,d0
...
loc_12426E:     jsr     sub_126380
		...
		bsr.w   sub_126284
		bsr.w   sub_1244CA
loc_12430C:     move.w  ((word_FFBC74-$1000000)).w,d0
		cmpi.w  #$FFFF,d0
		beq.w   loc_1243CE
		clr.w   d1
		move.w  ((unk_FFBC6E-$1000000)).w,d0
		bsr.w   sub_126326
		lea     (unk_FF3000).l,a0
		lea     (sub_8000).l,a1
		move.w  #$900,d0
		...
		bsr.w   sub_1262CE
		bsr.w   sub_124516
		move.w  ((unk_FFBC76-$1000000)).w,d0
		cmpi.w  #$FFFF,d0
		beq.s   loc_1243CE
		bsr.w   sub_12634C
		...
		bsr.w   sub_12630C
loc_1243CE:     move.w  ((word_FFBC74-$1000000)).w,d0
		cmpi.w  #$FFFF,d0
		beq.s   loc_1243DE
		jsr     sub_8014
...
loc_124672:     movem.l a0,-(sp)
		...
		beq.s   loc_1246BE
		bsr.w   sub_1253CC
		cmpi.w  #$FFFF,((unk_FFBC76-$1000000)).w
		beq.s   loc_1246BC
		clr.w   d0
		move.b  ((unk_FFB540-$1000000)).w,d0
		andi.w  #7,d0
...
loc_1249DC:     move.w  ((word_FFBC74-$1000000)).w,d0
		move.w  (a6)+,d1
		move.w  d1,-(sp)
		jsr     sub_201F0
		move.w  (a6)+,d1
...
loc_124A70:     move.w  d0,-(sp)
		...
		bsr.w   sub_124C58
return_124B20:  rts
loc_124B22:     move.w  ((word_FFBC74-$1000000)).w,d0
		move.w  d0,(a5)+
		move.w  #$FFFF,(a5)
		bsr.w   sub_124D1E
		movem.w d0-d2,-(sp)
...
sub_124DEE:
		bsr.w   sub_124754
		move.b  #$FF,((unk_FFB5BD-$1000000)).w
		rts

	; End of function sub_124DEE

loc_124DFA:     tst.b   ((unk_FFB5BC-$1000000)).w
		bne.s   loc_124DFA
		rts
loc_124E02:     move.w  (a6)+,d0
		move.w  (a6)+,((word_FFF844-$1000000)).w
...
sub_124ECC:
		tst.b   ((unk_FFB5BC-$1000000)).w
		beq.w   loc_124F1A
		clr.w   d0
		move.b  ((unk_FFB5BF-$1000000)).w,d0
		add.w   d0,d0
...
loc_1250F6:
		...
		bsr.w   sub_1255CC
		bset    #3,((byte_FFB4D2-$1000000)).w
		cmpi.w  #$FFFF,((word_FFBC74-$1000000)).w
		beq.s   return_12518A
		move.w  ((unk_FFBC76-$1000000)).w,d0
		cmpi.w  #$FFFF,d0
		beq.s   return_12518A
...
loc_12647E:     tst.b   ((unk_FFB5BC-$1000000)).w
		bne.w   return_1266BE
		tst.b   d0
		bmi.w   return_1266BE
		move.w  d0,d7
...
loc_126A38:     bsr.s   sub_1269EE
		bsr.w   sub_1266DA
		bsr.w   sub_126AD6
		move.b  d3,((unk_FFB5BE-$1000000)).w
		move.b  #7,((unk_FFB5BF-$1000000)).w
		clr.b   ((unk_FFB5BD-$1000000)).w
		move.b  #1,((unk_FFB5BC-$1000000)).w
		move.w  #$80,d6 
		move.w  #$60,d5 
		moveq   #1,d4
		clr.w   d3
...
loc_126EA0:     movem.l d3-d4,-(sp)
		...
		bsr.w   sub_126AD6
		move.b  d3,((unk_FFB5BE-$1000000)).w
		move.b  d4,((unk_FFB5BF-$1000000)).w
		clr.b   ((unk_FFB5BD-$1000000)).w
		move.b  #1,((unk_FFB5BC-$1000000)).w
		rts
unk_126EF0:     dc.b  $C
...
loc_126F10:     movea.l (off_12404C).l,a0
		...
		jsr     (sub_264).l
		bsr.w   sub_126AD6
		move.b  #$81,((unk_FFB5BE-$1000000)).w
		move.b  #3,((unk_FFB5BF-$1000000)).w
		clr.b   ((unk_FFB5BD-$1000000)).w
		move.b  #1,((unk_FFB5BC-$1000000)).w
		rts
unk_126F4A:     dc.b   0
...
loc_126F98:     trap    #0
		...
		jsr     (sub_264).l
		bsr.w   sub_126AD6
		move.b  #$11,((unk_FFB5BF-$1000000)).w
		clr.b   ((unk_FFB5BD-$1000000)).w
		move.b  #1,((unk_FFB5BC-$1000000)).w
		rts
unk_126FD0:     dc.b  $E
...
loc_12702C:     movea.l (off_124054).l,a0
		...
		jsr     (sub_264).l
		bsr.w   sub_126AD6
		move.b  #$12,((unk_FFB5BF-$1000000)).w
		clr.b   ((unk_FFB5BD-$1000000)).w
		move.b  #1,((unk_FFB5BC-$1000000)).w
		rts
...
loc_12709C:     trap    #0
		...
		bsr.w   sub_126AD6
		move.b  #1,((unk_FFB5BE-$1000000)).w
		move.b  #$13,((unk_FFB5BF-$1000000)).w
		clr.b   ((unk_FFB5BD-$1000000)).w
		move.b  #1,((unk_FFB5BC-$1000000)).w
		rts
unk_1270F4:     dc.b  $C
...
loc_1270FE:     lea     unk_1270F4(pc), a0
		...
		move.w  (a0)+,(a1)+
		jsr     (sub_224).l
		move.b  #$14,((unk_FFB5BF-$1000000)).w
loc_12711A:     trap    #0
		dc.w $69
...
loc_12715C:     trap    #0
		...
		move.w  (a0)+,(a1)+
		jsr     (sub_224).l
		move.b  #$15,((unk_FFB5BF-$1000000)).w
		bra.s   loc_12711A
unk_127182:     dc.b  $C
		dc.b $EE 
		dc.b   8
...
sub_1271EC:
	...
	; End of function sub_1271EC
		...
		rts
		clr.w   d7
		move.b  ((unk_FFB5BF-$1000000)).w,d7
		add.w   d7,d7
...
loc_127286:     clr.w   (RAM_START).l
		...
		move.b  ((unk_FFB5BE-$1000000)).w,d6
		andi.w  #7,d6
		cmpi.b  #2,d6
		bgt.s   loc_1272E0
		addq.w  #4,d7
loc_1272E0:     tst.b   ((unk_FFB5BD-$1000000)).w
		bpl.s   loc_1272EA
		move.w  #$120,d3
loc_1272EA:     mulu.w  #$14,d7
		...
		move.b  ((unk_FFB5BE-$1000000)).w,d7
		andi.w  #7,d7
		subq.w  #1,d7
		cmpi.w  #3,d7
		blt.s   loc_12730A
...
loc_12739C:     cmpi.b  #$FF,((unk_FFB5BD-$1000000)).w
		beq.s   loc_1273AC
		bsr.w   loc_1273E0
		bra.w   loc_1273D8
...
loc_12796C:     movem.l (sp)+,d0/d7-a0
		...
		addq.w  #8,a0
		dbf     d7,loc_127920
		cmpi.b  #$FF,((unk_FFB5BD-$1000000)).w
		beq.s   loc_1279A4
		bsr.w   loc_1279D4
		moveq   #$20,d6 
		jsr     (sub_2E0).w
...
loc_127A7C:     movem.l d0/d7-a0,-(sp)
		...
		bgt.s   loc_127AB2
		move.w  d7,4(a0)
loc_127AB2:     move.b  ((unk_FFB5BE-$1000000)).w,d2
		andi.b  #7,d2
		cmpi.b  #1,d2
		bne.s   loc_127AC4
		moveq   #1,d2
...
loc_127AE8:     lea     unk_127B4C(pc), a0
		move.b  ((unk_FFB5BE-$1000000)).w,d5
		andi.b  #7,d5
		cmpi.b  #1,d5
		beq.s   loc_127AFE
...
loc_127DBC:     cmpi.b  #$FF,((unk_FFB5BD-$1000000)).w
		beq.s   loc_127DCC
		bsr.w   loc_127DEE
		bra.w   loc_127DE8
...
loc_127F54:     cmpi.b  #$FF,((unk_FFB5BD-$1000000)).w
		beq.s   loc_127F64
		bsr.w   sub_127F86
		bra.w   loc_127F80
...
loc_127FD4:     movem.l d0/d7-a0,-(sp)
		...
		bne.s   loc_128042
		addq.w  #1,d7
loc_128042:     cmpi.b  #2,((unk_FFB5BE-$1000000)).w
		bgt.s   loc_128058
		cmpi.w  #$28,d7 
		bne.s   loc_128058
		movem.l (sp)+,d7
...
loc_12809A:     movem.l (sp)+,d0/d7-a0
		...
		bne.s   loc_1280BE
		move.w  #$EA0,(RAM_START).l
loc_1280BE:     cmpi.b  #$FF,((unk_FFB5BD-$1000000)).w
		beq.s   loc_1280CE
		bsr.w   loc_1280F0
		bra.w   loc_1280EA
...
loc_12826E:     cmpi.b  #$FF,((unk_FFB5BD-$1000000)).w
		bne.s   loc_128298
		lea     ((unk_FFB658-$1000000)).w,a0
		tst.w   (a0)
		beq.w   loc_12828C
		...
		ble.w   loc_128298
		clr.w   (a0)
loc_12828C:     clr.b   ((unk_FFB5BC-$1000000)).w
		bsr.w   sub_126704
		bsr.w   sub_126982
...
loc_128560:     moveq   #1,d1
		...
		sub.w   d2,d3
		eori.w  #1,d7
loc_12856E:     move.b  ((unk_FFB5BE-$1000000)).w,d2
		andi.w  #7,d2
		cmpi.w  #2,d2
		bne.s   loc_12857E
		addq.w  #8,d7
...
loc_128808:     cmpi.w  #$1E,((unk_FFB610-$1000000)).w
		...
		bsr.w   loc_12883E
		bra.w   loc_128838
loc_128818:     cmpi.b  #$FF,((unk_FFB5BD-$1000000)).w
		bne.s   loc_128838
		lea     ((unk_FFB5C4-$1000000)).w,a0
		clr.w   d0
		moveq   #$13,d7
...
loc_128A24:     jsr     (sub_224).w
		...
		jsr     (sub_260).l
return_128A36:  rts
loc_128A38:     cmpi.b  #$82,((unk_FFB5BE-$1000000)).w
		beq.w   loc_128988
		...
		moveq   #1,d1
		moveq   #2,d2
		move.b  ((unk_FFB5BE-$1000000)).w,d3
		move.b  d3,d4
		andi.b  #7,d3
		tst.b   d4
		bmi.s   loc_128A84
...
loc_12AE6A:     moveq   #$63,d0 
		jsr     (sub_38C).l
		move.w  #$2A,((unk_FFBC54-$1000000)).w 
		moveq   #$29,d0 
		jsr     sub_802C
		moveq   #$39,d1 
		bsr.w   loc_12C34E
...
loc_12B038:     moveq   #$30,d0 
		...
		jsr     sub_80AC
		bra.s   loc_12B074
loc_12B05C:     move.b  #4,((byte_FF9C01-$1000000)).w
		moveq   #$26,d1 
		moveq   #$10,d2
		moveq   #9,d3
		moveq   #7,d4
		...
		moveq   #0,d6
		jsr     sub_80AC
loc_12B074:     move.b  #$FF,((byte_FF9C03-$1000000)).w
		jsr     sub_20400
		jsr     sub_203A0
		trap    #0
		dc.w $4E

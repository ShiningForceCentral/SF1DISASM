...
loc_1039C:
		btst    #6,(TEMP_INPUT_STATES).l
		bne.s   loc_103B0
		btst    #5,(TEMP_INPUT_STATES).l
		beq.s   loc_103C8
loc_103B0:
		jsr     (sub_33C).l
...
MapDialogs:     incbin "data/maps/global/mapdialogs.bin"
...
loc_16F44:
		...
		rts
loc_16F56:
		jsr     j_GetDealsStockList
		move.w  ((word_FFA93E-$1000000)).w,d0
		rts

	; End of function sub_16F1C

ShopOffsets:    incbin "data/stats/items/shopoffsets.bin"
ShopData:       incbin "data/stats/items/shopdata.bin"
...
DialogHeader:   incbin "data/scripting/dialogheader.bin"

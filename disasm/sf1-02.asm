...
loc_811A:
		move.l  sp,(dword_FF0EFE).l
		clr.w   ((word_FF9C48-$1000000)).w
		move.w  #$101,((word_FF9C4A-$1000000)).w
		clr.b   ((byte_FFB4C7-$1000000)).w
		clr.b   ((byte_FFB4D7-$1000000)).w
		clr.b   ((byte_FFB53A-$1000000)).w
		jsr     sub_20400
		...
		clr.w   d0
		jsr     j_GetTargetX
		move.b  d1,((word_FF9C4A-$1000000)).w
		subq.w  #5,d1
		bge.s   loc_8160
		clr.w   d1
loc_8160:
		move.w  ((unk_FFBC52-$1000000)).w,d2
		subi.w  #$B,d2
		cmp.w   d2,d1
		ble.s   loc_816E
		move.w  d2,d1
loc_816E:
		move.b  d1,((word_FF9C48-$1000000)).w
		move.w  d1,d2
		jsr     j_GetTargetY
		move.b  d1,((word_FF9C4A+1-$1000000)).w
		subq.w  #5,d1
		bge.s   loc_8184
		clr.w   d1
loc_8184:
		move.w  ((unk_FFBC54-$1000000)).w,d2
		subi.w  #$A,d2
		cmp.w   d2,d1
		ble.s   loc_8192
		move.w  d2,d1
loc_8192:
		move.b  d1,((word_FF9C48+1-$1000000)).w
		clr.b   ((byte_FFB4D7-$1000000)).w
		bsr.w   sub_ACE4
		bsr.w   sub_84AE
...
loc_82DC:
		clr.w   d0
loc_82DE:
		move.b  ((byte_FF9C03-$1000000)).w,d0
		addi.w  #$28,d0 
		jsr     (sub_38C).l
		bsr.w   sub_AB2C
		jsr     sub_124010
...
sub_853E:
		move.b  #2,((unk_FFB4D6-$1000000)).w
		cmpi.b  #1,((word_FF9C4A+1-$1000000)).w
		beq.w   return_8DDE
		...
		bne.s   loc_8598
		move.w  ((unk_FFBC52-$1000000)).w,d0
		neg.w   d0
		btst    #0,(a0,d0.w)
		beq.w   return_8DDE
loc_8598:
		subq.b  #1,((word_FF9C4A+1-$1000000)).w
		move.b  #4,((unk_FFB4C3-$1000000)).w
		move.b  ((word_FF9C4A+1-$1000000)).w,d0
		sub.b   ((word_FF9C48+1-$1000000)).w,d0
		cmpi.b  #3,d0
		bne.s   return_85C0
		tst.b   ((word_FF9C48+1-$1000000)).w
		beq.s   return_85C0
...
sub_85C2:
		move.b  #0,((unk_FFB4D6-$1000000)).w
		move.w  ((unk_FFBC54-$1000000)).w,d7
		subq.w  #2,d7
		cmp.b   ((word_FF9C4A+1-$1000000)).w,d7
		beq.w   return_8DDE
		tst.b   ((byte_FFB538-$1000000)).w
		beq.w   loc_861E
		move.l  a0,-(sp)
		...
		beq.w   return_8DDE
loc_861E:
		addq.b  #1,((word_FF9C4A+1-$1000000)).w
		...
		move.w  ((unk_FFBC54-$1000000)).w,d7
		subi.b  #$A,d7
		cmp.b   ((word_FF9C48+1-$1000000)).w,d7
		beq.s   return_864E
...
sub_8650:
		move.b  #3,((unk_FFB4D6-$1000000)).w
		move.w  ((unk_FFBC52-$1000000)).w,d7
		subq.w  #2,d7
		cmp.b   ((word_FF9C4A-$1000000)).w,d7
		beq.w   return_8DDE
		tst.b   ((byte_FFB538-$1000000)).w
		beq.w   loc_86A8
		move.l  a0,-(sp)
		...
		beq.w   return_8DDE
loc_86A8:
		addq.b  #1,((word_FF9C4A-$1000000)).w
		move.b  #$FC,((unk_FFB4C2-$1000000)).w
		move.b  ((word_FF9C4A-$1000000)).w,d0
		sub.b   ((word_FF9C48-$1000000)).w,d0
		cmpi.b  #7,d0
		bne.s   return_86D8
		move.w  ((unk_FFBC52-$1000000)).w,d7
		subi.b  #$B,d7
		cmp.b   ((word_FF9C48-$1000000)).w,d7
		beq.s   return_86D8
...
sub_86DA:
		move.b  #1,((unk_FFB4D6-$1000000)).w
		cmpi.b  #1,((word_FF9C4A-$1000000)).w
		beq.w   return_8DDE
		tst.b   ((byte_FFB538-$1000000)).w
		beq.w   loc_872E
		move.l  a0,-(sp)
		...
		beq.w   return_8DDE
loc_872E:
		subq.b  #1,((word_FF9C4A-$1000000)).w
		move.b  #4,((unk_FFB4C2-$1000000)).w
		move.b  ((word_FF9C4A-$1000000)).w,d0
		sub.b   ((word_FF9C48-$1000000)).w,d0
		cmpi.b  #3,d0
		bne.s   return_8758
		cmpi.b  #0,((word_FF9C48-$1000000)).w
		beq.s   return_8758
...
sub_87AA:
		...
		sub.b   ((word_FF9C48+1-$1000000)).w,d0
		mulu.w  #$18,d0
		move.w  d0,((unk_FFB7C2-$1000000)).w
		clr.w   d0
		move.b  ((word_FF9C4A-$1000000)).w,d0
		sub.b   ((word_FF9C48-$1000000)).w,d0
		mulu.w  #$18,d0
		move.w  d0,((unk_FFB7C0-$1000000)).w
		clr.w   d1
		clr.w   d2
...
sub_87D2:
		...
		moveq   #7,d7
loc_87F4:
		move.w  ((unk_FFB7C2-$1000000)).w,d0
		add.w   (a0)+,d0
		ext.w   d2
		add.w   d2,d0
		move.w  d0,(a1)+
		move.w  (a0)+,(a1)+
		move.w  (a0)+,(a1)+
		move.w  ((unk_FFB7C0-$1000000)).w,d0
		add.w   (a0)+,d0
		ext.w   d1
		add.w   d1,d0
		move.w  d0,(a1)+
...
loc_8A36:
		...
		sub.w   d0,d3
		asr.w   #2,d0
		add.b   d0,((word_FF9C48-$1000000)).w
...
sub_8A8A:
		...
		sub.w   d0,d4
		asr.w   #2,d0
		sub.b   d0,((word_FF9C48+1-$1000000)).w
		move.b  #1,((unk_FFB4C4-$1000000)).w
		rts
loc_8ABC:
		move.w  d4,d6
...
loc_8CEA:
		...
		bsr.w   sub_87AA
		clr.w   d1
		move.b  ((word_FF9C4A+1-$1000000)).w,d1
		mulu.w  ((unk_FFBC52-$1000000)).w,d1
		clr.w   d0
		move.b  ((word_FF9C4A-$1000000)).w,d0
		add.w   d1,d0
		lea     (unk_FFA4C0).l,a0
		adda.w  d0,a0
		btst    #0,(byte_FF0E97).l
		beq.s   loc_8D1C
		bsr.w   sub_853E
		bra.s   loc_8D4A
loc_8D1C:
		btst    #1,(byte_FF0E97).l
		beq.s   loc_8D2C
		bsr.w   sub_85C2
		bra.s   loc_8D4A
loc_8D2C:
		btst    #2,(byte_FF0E97).l
		beq.s   loc_8D3C
		bsr.w   sub_86DA
		bra.s   loc_8D4A
loc_8D3C:
		btst    #3,(byte_FF0E97).l
		beq.s   loc_8D4A
		bsr.w   sub_8650
loc_8D4A:
		tst.l   ((unk_FFB4C0-$1000000)).w
...
sub_8DE2:
		...
		clr.w   d1
		clr.w   d2
		move.b  ((word_FF9C48-$1000000)).w,d1
		move.b  ((word_FF9C48+1-$1000000)).w,d2
		mulu.w  d0,d2
		add.w   d2,d1
		move.l  d1,-(sp)
		add.w   d1,d1
...
sub_8E52:
		move.b  d0,((unk_FFB51F-$1000000)).w
		lsr.w   #8,d0
		move.b  d0,((unk_FFB51E-$1000000)).w
loc_8E5C:
		clr.l   ((unk_FFB4C0-$1000000)).w
		bsr.w   sub_87AA
		move.b  ((word_FF9C4A-$1000000)).w,d0
		cmp.b   ((unk_FFB51E-$1000000)).w,d0
		ble.s   loc_8E76
		bsr.w   sub_86DA
		bra.w   loc_8E7C
loc_8E76:
...
loc_8EA0:
		jsr     (sub_240).l
		move.b  ((word_FF9C4A-$1000000)).w,d0
		sub.b   ((unk_FFB51E-$1000000)).w,d0
		move.b  ((word_FF9C4A+1-$1000000)).w,d1
		sub.b   ((unk_FFB51F-$1000000)).w,d1
		or.b    d1,d0
		bne.s   loc_8E5C
		rts
...
loc_8F7A:
		clr.w   d1
		move.b  ((byte_FF9C00-$1000000)).w,d1
		subq.w  #1,d1
		lsl.w   #2,d1
...
sub_9126:
		...
		move.w  ((unk_FFBC52-$1000000)).w,d3
		move.w  ((unk_FFBC54-$1000000)).w,d4
		movem.w d1-d4,-(sp)
		movea.l (p_Maps).l,a0
		lsl.w   #5,d0
		adda.w  d0,a0
		...
		movem.l a1-a2,-(sp)
		movea.l a3,a0
		move.l  #unk_FF3000,((dword_FFF006-$1000000)).w
		clr.w   d0
		jsr     sub_10014
		movem.l (sp)+,a1-a2
		movem.w (sp)+,d1-d4
		lea     (unk_FF3000).l,a4
		lea     (word_FF5000).l,a3
		clr.w   d5
		move.b  (byte_FFF800).l,d5
		move.w  d5,d6
		mulu.w  d2,d5
		add.w   d1,d5
		add.w   d5,d5
...
loc_92DA:
		...
		jsr     (sub_2FC).l
		move.w  (sp)+,d0
		tst.b   ((byte_FF9C03-$1000000)).w
		blt.s   return_930C
		tst.w   d0
		blt.s   return_930C
		move.w  d0,((unk_FFBC54-$1000000)).w
return_930C:
		rts
...
off_93E4:
		...
		dc.w return_9484-off_93E4
		dc.w return_9484-off_93E4
		dc.w return_9486-off_93E4
		dc.w loc_9498-off_93E4
		dc.w loc_9488-off_93E4
		dc.w return_94A8-off_93E4
		dc.w return_94A8-off_93E4
		dc.w return_94A8-off_93E4
		dc.w return_94A8-off_93E4
		dc.w return_94A8-off_93E4
		...
		dc.w return_9564-off_93E4
		dc.w loc_9566-off_93E4
		dc.w return_9576-off_93E4
		dc.w loc_9578-off_93E4
		dc.w return_95E2-off_93E4
		dc.w return_95E2-off_93E4
loc_944C:
		moveq   #$20,d1 
		moveq   #0,d2
...
loc_960A:
		...
		move.w  (a4)+,d0
loc_9626:
		move.w  ((unk_FFBC52-$1000000)).w,d5
		add.w   d5,d5
		move.w  d5,d1
		add.w   d5,d5
		add.w   d1,d5
		subq.l  #4,d5
		lea     (word_FF5000).l,a3
		mulu.w  ((unk_FFBC52-$1000000)).w,d4
		add.w   d4,d4
		move.w  d4,d1
		lsl.w   #3,d4
		add.w   d1,d4
...
sub_96AE:
		clr.w   d7
		move.b  ((byte_FF9C00-$1000000)).w,d7
		subq.w  #1,d7
		lsl.w   #7,d7
		movea.l (off_10030).l,a0
		adda.w  d7,a0
...
loc_98C2:
		move.b  2(a0),d1
loc_98C6:
		sub.b   ((word_FF9C48+1-$1000000)).w,d1
		ext.w   d1
		move.w  d1,d2
		add.w   d1,d1
		add.w   d2,d1
...
loc_990A:
		move.w  d0,(a1)+
		move.b  1(a0),d1
		sub.b   ((word_FF9C48-$1000000)).w,d1
		ext.w   d1
		move.w  d1,d2
		add.w   d1,d1
		add.w   d2,d1
...
sub_99FC:
		lea     plt_MapSpritePalettes(pc), a0
loc_9A00:
		lea     (unk_FF00C0).l,a1
		moveq   #$1F,d0
		jmp     (loc_2C0).l
...
sub_9D08:
		...
		move.b  ((word_FF9C4A-$1000000)).w,((unk_FFB535-$1000000)).w
		move.b  ((word_FF9C4A+1-$1000000)).w,((unk_FFB536-$1000000)).w
		bsr.w   sub_AB5C
		bcs.w   loc_AAE4
		clr.b   ((byte_FFB4C7-$1000000)).w
...
loc_9E00:
		...
		tst.b   ((byte_FFB4D7-$1000000)).w
		bne.s   loc_9E26
		clr.b   ((unk_FFB4D6-$1000000)).w
loc_9E26:
		move.b  ((word_FF9C4A+1-$1000000)).w,d0
		lsl.w   #8,d0
		or.b    ((word_FF9C4A-$1000000)).w,d0
...
loc_9E8A:
		...
		jsr     (sub_240).l
		movem.w (sp)+,d3-d4
		cmpi.b  #$7F,((byte_FF9C02-$1000000)).w 
		beq.w   loc_9F68
		cmpi.b  #$7E,((byte_FF9C02-$1000000)).w 
		beq.w   loc_9F88
		cmpi.b  #$7D,((byte_FF9C02-$1000000)).w 
		bne.s   loc_9ECC
		moveq   #$25,d0 
		jsr     (sub_38C).l
...
loc_9ECC:
		...
		cmp.b   ((byte_FF9C02-$1000000)).w,d0
		bne.s   loc_9EF8
		move.w  #$1B3,d0
		trap    #8
		bra.s   loc_9EFE
...
loc_A026:
		...
		move.b  ((unk_FFB4C5-$1000000)).w,d0
		move.b  ((word_FF9C4A+1-$1000000)).w,d1
		move.b  ((word_FF9C4A-$1000000)).w,d2
		jsr     sub_202D4
...
loc_A074:
		...
		move.b  #$FF,((byte_FFB4D3-$1000000)).w
		move.b  d1,((word_FF9C4A-$1000000)).w
		move.b  d2,((word_FF9C4A+1-$1000000)).w
		move.b  d0,((byte_FFB4C6-$1000000)).w
		bsr.w   sub_AB2C
		bsr.w   sub_A8C0
		bsr.w   sub_9940
...
loc_A0DE:
		...
		move.b  2(a0),d2
		clr.w   d3
		move.b  ((word_FF9C4A-$1000000)).w,d3
		move.b  d3,1(a0)
		clr.w   d4
		move.b  ((word_FF9C4A+1-$1000000)).w,d4
		move.b  d4,2(a0)
		bsr.w   sub_9940
		bsr.w   sub_A8C0
...
loc_A132:
		...
		bra.w   loc_A17A
loc_A15C:
		clr.b   ((unk_FFCBB2-$1000000)).w
		clr.b   ((unk_FFCB3E-$1000000)).w
		bsr.w   sub_ADA6
...
sub_A1AE:
		...
		cmpi.w  #$FFFF,d0
		beq.s   loc_A1F0
		move.b  d0,((unk_FFB51D-$1000000)).w
		bra.w   sub_ACD4
loc_A1E4:
		jsr     (sub_240).l
		clr.w   d0
...
loc_A3A0:
		...
		bra.s   loc_A354
loc_A3AE:
		move.b  ((byte_FFB528-$1000000)).w,((unk_FFB51C-$1000000)).w
		jsr     sub_202D8
		tst.b   ((unk_FFC600-$1000000)).w
		beq.w   loc_A3E8
		subq.w  #1,((word_FFA8C0-$1000000)).w
...
loc_A744:
		...
		moveq   #1,d0
		bsr.w   sub_AB9C
		move.b  ((unk_FFB51D-$1000000)).w,d0
		cmpi.b  #$FF,d0
		blt.w   loc_A8BA
		jsr     (sub_240).l
...
loc_ABB4:
		...
		move.w  ((unk_FFBC54-$1000000)).w,d7
		subq.w  #1,d7
		move.w  ((unk_FFBC52-$1000000)).w,d4
		move.w  d4,d1
		add.w   d4,d4
		add.w   d1,d4
		lsl.w   #2,d4
loc_ABDA:
		move.w  ((unk_FFBC52-$1000000)).w,d6
		subq.w  #1,d6
loc_ABE0:
		move.b  (a0)+,d1
		move.w  d0,d3
...
loc_AD42:
		move.b  ((byte_FF9C01-$1000000)).w,d0
		bpl.s   loc_AD54
		cmpi.w  #$21A,((word_FF9C4A-$1000000)).w
		bne.s   loc_AD54
		moveq   #1,d0
		rts
loc_AD54:
...
loc_AD9C:
		...
		rts
loc_ADA0:
		move.b  d0,((byte_FF9C02-$1000000)).w
		rts
...
sub_ADB8:
		clr.w   d3
		move.b  ((unk_FFB4D6-$1000000)).w,d3
		add.w   d3,d3
...
loc_ADE0:
		tst.b   ((byte_FFB4D7-$1000000)).w
		bne.s   loc_ADEC
		clr.b   ((unk_FFB4D5-$1000000)).w
		bra.s   loc_ADF2
loc_ADEC:
		move.b  #1,((unk_FFB4D5-$1000000)).w
loc_ADF2:
		clr.w   d7
		move.b  ((byte_FF9C00-$1000000)).w,d7
		subq.w  #1,d7
...
loc_B5B0:
		clr.w   d2
		move.b  ((unk_FFB51E-$1000000)).w,d2
		clr.w   d3
		move.b  ((unk_FFB51F-$1000000)).w,d3
		move.w  d0,d6
		sub.w   d2,d6
		subq.w  #4,d6
		jsr     (sub_284).l
...
sub_B936:
		clr.w   d2
		move.b  ((word_FF9C4A+1-$1000000)).w,d2
		move.w  ((unk_FFBC52-$1000000)).w,d1
		mulu.w  d1,d2
		clr.w   d1
		move.b  ((word_FF9C4A-$1000000)).w,d1
		add.w   d2,d1
...
loc_BEFC:
		moveq   #3,d7
loc_BEFE:
		move.b  d7,((byte_FFB528-$1000000)).w
...
loc_BF6A:
		...
		bsr.w   sub_C262
		bcs.w   loc_BF8C
		move.b  #1,((byte_FFB528-$1000000)).w
		trap    #0
...
loc_BF8C:
		...
		bsr.w   sub_C262
		bcs.s   loc_BFAC
		move.b  #2,((byte_FFB528-$1000000)).w
		trap    #0
...
loc_BFC2:
		...
		bsr.w   sub_C262
		bcs.s   loc_BFE2
		move.b  #3,((byte_FFB528-$1000000)).w
		trap    #0
...
sub_C1DA:
		move.b  ((byte_FFB528-$1000000)).w,d7
...
loc_C3C4:
		...
		bne.s   loc_C440
		cmpi.b  #0,((byte_FFB528-$1000000)).w
		bne.s   loc_C42C
		btst    #1,((unk_FFB4D5-$1000000)).w
		beq.s   loc_C42C
		lea     unk_C89C(pc), a0
loc_C42C:
		cmpi.b  #3,((byte_FFB528-$1000000)).w
		bne.s   loc_C440
		btst    #0,((unk_FFB4D5-$1000000)).w
		beq.s   loc_C440
		lea     unk_C895(pc), a0
loc_C440:
		cmpi.b  #4,((byte_FFB526-$1000000)).w
		bne.s   loc_C45C
		cmpi.b  #1,((byte_FFB528-$1000000)).w
		bne.s   loc_C45C
		btst    #2,((unk_FFB4D5-$1000000)).w
		beq.s   loc_C45C
		lea     unk_C8A1(pc), a0
loc_C45C:
		clr.w   d7
...
loc_C522:
		...
		cmpi.w  #$A,d6
		ble.s   loc_C54E
		cmpi.b  #2,((byte_FFB528-$1000000)).w
		bne.s   loc_C54E
		adda.w  #$120,a0
loc_C54E:
		moveq   #8,d7
...
loc_D7C6:
		...
		bra.s   loc_D7C6
loc_D7D0:
		move.b  d0,((byte_FFB528-$1000000)).w
...
loc_D942:
		...
		cmp.b   ((byte_FFB528-$1000000)).w,d3
		beq.s   loc_D9A0
		move.w  ((word_FFBC58-$1000000)).w,d2
		bsr.w   loc_DAC0
		bsr.w   sub_DCFA
		move.b  d3,((byte_FFB528-$1000000)).w
		bsr.w   sub_DAE2
		bsr.w   sub_DA12
		jsr     (sub_240).l
		moveq   #$13,d6
...
sub_DAAA:
		lea     ((unk_FFA8C2-$1000000)).w,a0
		clr.w   d2
		move.b  ((byte_FFB528-$1000000)).w,d2
		lsl.w   #2,d2
...
loc_EB3A:
		btst    #4,(byte_FF0E99).l
		beq.s   loc_EB4E
		move.b  #$FF,((byte_FFB528-$1000000)).w
		bra.w   loc_EB94
loc_EB4E:
		btst    #5,(byte_FF0E99).l
		beq.s   loc_EB5C
...
sub_F63A:
		...
		move.l  (a0)+,(a1)+
		jsr     (sub_224).l
		move.b  #9,(byte_FF0EB7).l
		clr.b   (byte_FF0EBA).l
		move.b  (byte_FF0EB9).l,(byte_FF0EBB).l
		move.b  #$D,(byte_FF0EBC).l
...
sub_F7CE:
		...
		add.w   d5,d5
		moveq   #2,d4
		move.w  ((unk_FFBC54-$1000000)).w,d6
		subq.w  #1,d6
loc_F7EE:
		jsr     (sub_208).l
		jsr     (sub_240).l
...
sub_FB38:
		...
		addq.w  #4,d0
		lsl.w   #7,d0
		move.w  ((unk_FFBC54-$1000000)).w,d1
		addq.w  #4,d1
		lsr.w   #1,d1
		or.w    d1,d0
		move.w  d0,-(sp)
		moveq   #$3C,d0 
		sub.w   ((unk_FFBC52-$1000000)).w,d0
		lsl.w   #6,d0
		moveq   #$34,d1 
		sub.w   ((unk_FFBC54-$1000000)).w,d1
		lsr.w   #2,d1
		or.w    d0,d1
		move.w  d1,d0
		swap    d0
...
sub_FBD6:
		moveq   #$40,d2 
		sub.w   ((unk_FFBC52-$1000000)).w,d2
		lsr.w   #2,d2
		lsl.w   #3,d2
		addi.w  #$80,d2 
		moveq   #$38,d3 
		sub.w   ((unk_FFBC54-$1000000)).w,d3
		lsr.w   #2,d3
		lsl.w   #3,d3
		addi.w  #$80,d3 
		rts
...
off_1002C:      dc.l off_1D3B2
off_10030:      dc.l BattleChests
...
j_DecompressText:
	...
	; End of function j_DecompressText
...
; START OF FUNCTION CHUNK FOR sub_1096C

loc_10050:
		bsr.w   sub_1010E
		move.b  (byte_FF9C02).l,d1
		bra.s   loc_1005E
loc_1005C:
		clr.w   d1
loc_1005E:
...
loc_1038C:
		...
		move.b  (a0),d0
loc_10396:
		move.b  d0,(byte_FFF818).l
loc_1039C:
		btst    #6,(byte_FFF818).l
		bne.s   loc_103B0
		btst    #5,(byte_FFF818).l
		beq.s   loc_103C8
loc_103B0:
		jsr     (sub_33C).l
		andi.b  #$F,(byte_FFF818).l
		move.b  #$FF,(byte_FFF81C).l
return_103C6:
		rts
loc_103C8:
		move.b  (word_FF5000).l,d0
		move.b  (word_FF5000+1).l,d1
		clr.w   d2
		move.b  #3,d5
		move.b  (byte_FFF818).l,d3
		andi.b  #$F,d3
		lsl.b   #2,d3
		ext.w   d3
...
; START OF FUNCTION CHUNK FOR sub_10310
...
; END OF FUNCTION CHUNK FOR sub_10310
...
sub_1052C:
		clr.b   (byte_FFF821).l
		movem.w d0-d1,-(sp)
		andi.b  #$E7,(byte_FF5002).l
		ori.b   #8,(byte_FF5002).l
		addq.b  #1,d0
		bsr.w   sub_1071E
		bcs.w   loc_106D6
		addq.b  #1,(word_FF5000).l
...
loc_105BA:
		...
		movem.w d0-d1,-(sp)
		andi.b  #$E7,(byte_FF5002).l
		ori.b   #$10,(byte_FF5002).l
		addq.b  #1,d1
		bsr.w   sub_1071E
		bcs.w   loc_106D6
		addq.b  #1,(word_FF5000+1).l
		move.w  (word_FFF8D6).l,d0
		andi.w  #$7F,(word_FFF8D6).l 
		addi.w  #$180,d0
		andi.w  #$EF80,d0
...
loc_10606:
		clr.b   (byte_FFF821).l
		movem.w d0-d1,-(sp)
		ori.b   #$18,(byte_FF5002).l
		subq.b  #1,d0
		bsr.w   sub_1071E
		bcs.w   loc_106D6
		subq.b  #1,(word_FF5000).l
		move.w  (word_FFF8D6).l,d0
		andi.w  #$EF80,(word_FFF8D6).l
		subq.w  #6,d0
		andi.b  #$7F,d0 
...
loc_10688:
		bsr.w   sub_10D20
		move.w  (word_FFF8CE).l,d0
		move.w  (a3),d1
		move.w  d1,(word_FFF8D0).l
		move.w  (a2),d1
		move.w  d1,(word_FFF8CE).l
		andi.w  #$7000,d0
...
sub_10842:
		...
		bne.s   loc_1089E
		clr.b   (byte_FFF81B).l
		move.w  (word_FF5000).l,d0
		move.w  d0,(word_FF51B0).l
		move.w  (dword_FF5004).l,d0
		move.w  d0,(word_FF51B4).l
		move.w  (dword_FF5004+2).l,d0
		move.w  d0,(word_FF51B6).l
		move.b  (byte_FF5002).l,d0
		andi.b  #$18,d0
...
sub_108BC:
		...
		move.b  d0,(byte_FF5003).l
loc_108E0:
		move.b  (word_FF5000).l,d0
		cmp.b   (byte_FFF800).l,d0
		bcc.s   loc_1095C
		move.b  (word_FF5000+1).l,d0
		cmp.b   (byte_FFF801).l,d0
		bcc.s   loc_1095C
		move.b  (word_FFF8D0).l,d0
		lsr.b   #2,d0
		andi.w  #$1F,d0
		cmpi.w  #1,d0
		beq.s   loc_10966
...
sub_10C60:
		add.b   (word_FF5000).l,d0
		add.b   (word_FF5000+1).l,d1
...
loc_11318:
		...
		move.b  (word_FF5000).l,d0
		move.b  (word_FF5000+1).l,d1
		lea     word_113F4(pc), a4
		lea     word_1141C(pc), a5
		add.b   5(a4,d4.w),d0
		add.b   9(a5,d3.w),d0
		add.b   7(a4,d4.w),d1
		add.b   $B(a5,d3.w),d1
...
loc_113C2:
		...
		andi.w  #$6FFE,d6
		move.w  d6,d5
		add.w   word_113F4(pc,d4.w),d6
		add.w   word_1141C(pc,d3.w),d6
		andi.w  #$7E,d6 
		add.w   word_113F6(pc,d4.w),d5
		add.w   word_1141E(pc,d3.w),d5
		andi.w  #$6F80,d5
		ori.w   #$6000,d5
		or.w    d5,d6
		rts
...
sub_115A4:
		move.b  (word_FF5000).l,d4
		subq.b  #6,d4
		sub.b   d4,d0
		cmpi.b  #$D,d0
		bcc.s   loc_115F2
		move.b  (word_FF5000+1).l,d5
		subq.b  #5,d5
		sub.b   d5,d1
		cmpi.b  #$A,d1
		bcc.s   loc_115F2
...
loc_119EC:
		...
		bra.s   loc_119EC
loc_119FC:
		move.l  #$FFFFFFFF,(dword_FFF92C).l
		move.b  #$FF,(byte_FFF808).l
		rts
loc_11A10:
		move.b  1(a0,d1.w),d0
		bsr.s   sub_11A30
		move.b  d0,(byte_FFF808).l
		ext.w   d0
		lsl.w   #2,d0
		movea.l (p_pt_SpriteSets).l,a0
		move.l  (a0,d0.w),(dword_FFF92C).l
		rts
...
sub_11D52:
		move.b  -4(a1),d0
		sub.b   (word_FF5000).l,d0
		ext.w   d0
		mulu.w  #$18,d0
		addi.w  #$800,d0
		move.w  d0,(a1)+
		move.b  -5(a1),d0
		sub.b   (word_FF5000+1).l,d0
		ext.w   d0
		mulu.w  #$18,d0
		addi.w  #$7F8,d0
		move.w  d0,(a1)+
...
sub_11FF8:
		cmpi.b  #$2D,(byte_FFF808).l 
		bne.s   loc_12008
		bsr.w   sub_16306
		rts
loc_12008:
		cmpi.b  #0,(byte_FFF808).l
		bne.s   loc_12058
...
loc_12500:
		...
		cmpi.b  #$15,(byte_FFF808).l
		bne.w   loc_12600
		cmpi.b  #9,(word_FF5000+1).l
		beq.s   loc_1253A
		cmpi.b  #$12,(word_FF5000+1).l
		beq.s   loc_1253A
...
return_125FE:
		rts
loc_12600:
		cmpi.b  #$17,(byte_FFF808).l
		bne.s   loc_1261A
		cmpi.b  #$19,(word_FF5000).l
		bne.s   return_12618
		bsr.w   sub_16306
return_12618:
		rts
loc_1261A:
		cmpi.b  #$16,(byte_FFF808).l
		bne.s   loc_12634
		cmpi.b  #$10,(word_FF5000).l
		bne.s   return_12632
		bsr.w   sub_16306
return_12632:
		rts
loc_12634:
		cmpi.b  #$18,(byte_FFF808).l
		bne.w   loc_126BC
		btst    #0,(byte_FF9C56).l
		beq.s   loc_12652
		move.b  #$FF,(byte_FF5051).l
...
sub_12C62:
		...
		clr.w   d7
		move.b  (word_FF5000).l,d1
		move.b  (word_FF5000+1).l,d2
loc_12C74:
		move.b  (a0,d7.w),d0
		bmi.w   loc_12D40
		bsr.w   sub_12D74
...
loc_12CA2:
		...
		move.b  4(a0,d7.w),d0
		bsr.w   sub_12D74
		move.b  5(a0,d7.w),(word_FF5000).l
		move.b  6(a0,d7.w),(word_FF5000+1).l
		tst.b   7(a0,d7.w)
		bmi.s   loc_12CCC
		trap    #0
		dc.w $55
...
loc_12CD8:
		...
		btst    #3,(byte_FF9C5A).l
		beq.s   loc_12D02
		cmpi.b  #$47,(word_FF5000).l 
		bne.s   loc_12D02
		move.b  #$2D,(word_FF5000).l 
		move.b  #8,(word_FF5000+1).l
loc_12D02:
		tst.b   d0
		rts
...
loc_12D06:
		move.b  -4(a0,d7.w),d0
		bsr.w   sub_12D74
		move.b  -3(a0,d7.w),(word_FF5000).l
		move.b  -2(a0,d7.w),(word_FF5000+1).l
		tst.b   -1(a0,d7.w)
		bmi.s   loc_12D2A
		trap    #0
...
sub_131BE:
		move.b  (byte_FFF800).l,d0
		ext.w   d0
		move.b  (byte_FFF801).l,d7
		ext.w   d7
		mulu.w  d0,d7
		subq.w  #1,d7
		clr.w   d1
...
loc_136F0:
		...
		bsr.w   sub_137CA
loc_13716:
		cmpi.b  #$38,(word_FF5000+1).l 
		bne.s   return_1373A
		btst    #7,(byte_FF9C59).l
		beq.s   return_1373A
		move.b  #$16,(word_FF5000).l
		move.b  #$A,(word_FF5000+1).l
return_1373A:
		rts
loc_1373C:
...
loc_13D44:
		...
		bra.w   loc_15CC0
loc_13D54:
		cmpi.b  #$22,(word_FF5000+1).l 
		bne.w   loc_15CC6
		cmpi.b  #$1F,(word_FF5000).l
		bcs.w   loc_15CC6
...
loc_13DD2:
		lea     (word_FF5000).l,a6
		move.w  #$1812,word_FF5040-word_FF5000(a6)
		move.w  #$1A12,$50(a6)
		move.w  #$1C12,$60(a6)
		move.w  #$1814,$70(a6)
		move.w  #$1A14,$80(a6)
		...
		bra.w   loc_15CC0
loc_13EA0:
		cmpi.b  #$10,(word_FF5000+1).l
		beq.s   loc_13EB6
		cmpi.b  #$B,(word_FF5000+1).l
		bne.w   loc_15CC6
loc_13EB6:
		cmpi.b  #$F,(word_FF5000).l
		bcs.w   loc_15CC6
		cmpi.b  #$15,(word_FF5000).l
		bhi.w   loc_15CC6
		bra.w   loc_15CC0
loc_13ED2:
		addq.b  #1,1(a0)
...
loc_14292:
		...
		bra.w   loc_15CC0
loc_142D8:
		cmpi.b  #$14,(word_FF5000+1).l
		bne.w   loc_15CC6
		cmpi.b  #$30,(word_FF5000).l 
		beq.w   loc_15CC0
		cmpi.b  #$31,(word_FF5000).l 
		bne.w   loc_15CC6
		bra.w   loc_15CC0
loc_14300:
		clr.b   d2
...
loc_14ABE:
		cmpi.b  #$C,(word_FF5000+1).l
		bne.w   loc_15CC6
		cmpi.b  #6,(word_FF5000).l
		bne.w   loc_14AE0
		ori.b   #$18,2(a0)
		bra.w   loc_15CC0
loc_14AE0:
		cmpi.b  #$E,(word_FF5000).l
		bne.w   loc_15CC6
		andi.b  #$E7,2(a0)
		ori.b   #8,2(a0)
		bra.w   loc_15CC0
loc_14AFC:
		cmpi.b  #$D,(word_FF5000+1).l
		bne.w   loc_15CC6
		bra.w   loc_15CC0
loc_14B0C:
		cmpi.b  #6,(a0)
...
loc_14ECE:
		cmpi.b  #$12,(word_FF5000+1).l
		bne.w   loc_15CC6
		cmpi.b  #$27,(word_FF5000).l 
		beq.w   loc_15CC0
		cmpi.b  #$28,(word_FF5000).l 
		bne.w   loc_15CC6
		bra.w   loc_15CC0
loc_14EF6:
		move.b  #0,d2
...
loc_14F2A:
		btst    #0,(byte_FF9C59).l
		bne.w   loc_15CC6
		cmpi.b  #$28,(word_FF5000+1).l 
		bne.w   loc_15CC6
		cmpi.b  #$1E,(word_FF5000).l
		beq.w   loc_15CC0
		cmpi.b  #$1F,(word_FF5000).l
		bne.w   loc_15CC6
		bra.w   loc_15CC0
...
; START OF FUNCTION CHUNK FOR sub_13A30

loc_15CC6:
		tst.b   d0
		rts

; END OF FUNCTION CHUNK FOR sub_13A30
...
; END OF FUNCTION CHUNK FOR sub_15F58
		...
		bra.w   loc_16300
		bra.w   loc_1631A
loc_1604A:      bsr.w   sub_15FC2
		bsr.w   sub_13A30
		bcs.w   loc_15FA6
		subq.b  #2,$C(a0)
		bra.w   loc_15FAE
loc_1605E:      bsr.w   sub_15FC2
		move.w  d0,d1
		bsr.w   sub_15FC2
		lea     (unk_FF9C4E).l,a6
		move.b  (a6,d1.w),d2
		...
		subq.b  #3,$C(a0)
		bra.w   loc_15FAE
loc_1608C:      movem.w (sp)+,d2
		move.b  d2,(a6,d1.w)
		bra.w   loc_15FA6
loc_16098:      bsr.w   sub_15FC2
		move.w  d0,d1
		bsr.w   sub_15FC2
		lea     (unk_FF9C4E).l,a6
		or.b    d0,(a6,d1.w)
		bra.w   loc_15FA6
loc_160B0:      bsr.w   sub_15FC2
		move.w  d0,d1
		bsr.w   sub_15FC2
		lea     (unk_FF9C4E).l,a6
		and.b   d0,(a6,d1.w)
...
loc_160CC:      subq.b  #1,$C(a0)
		bra.w   loc_15FAE
loc_160D4:      andi.b  #$E7,2(a0)
		move.w  #4,d6
		jsr     (sub_2E0).l
		lsl.b   #3,d7
		or.b    d7,2(a0)
		bra.w   loc_15FA6
loc_160EE:      eori.b  #$10,2(a0)
		bra.w   loc_15FA6
loc_160F8:      andi.b  #$E7,2(a0)
		bra.w   loc_15FA6
loc_16102:      andi.b  #$E7,2(a0)
		ori.b   #8,2(a0)
		bra.w   loc_15FA6
loc_16112:      andi.b  #$E7,2(a0)
		ori.b   #$10,2(a0)
		bra.w   loc_15FA6
loc_16122:      ori.b   #$18,2(a0)
		bra.w   loc_15FA6
loc_1612C:      move.b  2(a0),d0
		addi.b  #8,d0
loc_16134:      andi.b  #$E7,2(a0)
		andi.b  #$18,d0
		or.b    d0,2(a0)
		bra.w   loc_15FA6
loc_16146:      move.b  2(a0),d0
		subi.b  #8,d0
		bra.s   loc_16134
loc_16150:      move.b  $F(a0),d0
		andi.b  #$C0,$F(a0)
		andi.b  #$3F,d0 
		bne.s   loc_16174
		bsr.w   sub_15FC2
...
loc_16174:      subq.b  #1,d0
		...
		bpl.w   loc_1618E
		bra.w   loc_15FAE
loc_1618E:      andi.b  #$C0,$F(a0)
		addq.b  #2,$C(a0)
		bra.w   loc_15FAE
loc_1619C:      move.b  $F(a0),d0
		andi.b  #$C0,$F(a0)
		andi.b  #$3F,d0 
		bne.s   loc_161B6
		bsr.w   sub_15FC2
...
loc_1627C:      addq.b  #1,$C(a0)
		bra.w   loc_15FA6
loc_16284:      clr.b   $C(a0)
		bra.w   loc_15FA6
loc_1628C:      bsr.w   sub_15FC2
		move.b  d0,$C(a0)
		bra.w   loc_15FA6
loc_16298:      bclr    #6,9(a0)
		bra.w   loc_15FA6
loc_162A2:      bset    #6,9(a0)
		bra.w   loc_15FA6
loc_162AC:      bsr.w   sub_15FC2
		move.b  d0,$A(a0)
		move.b  d0,$B(a0)
		bra.w   loc_15FA6
loc_162BC:      bsr.w   sub_15FC2
		move.w  d0,d1
		bsr.w   sub_15FC2
		cmp.b   (word_FF5000).l,d1
		bne.s   loc_162D8
		cmp.b   (word_FF5000+1).l,d0
		beq.w   loc_15FA6
loc_162D8:      subq.b  #3,$C(a0)
		bra.w   loc_15FAE
loc_162E0:      bsr.w   sub_15FC2
		lsl.w   #2,d0
		lea     off_16632(pc), a6
		movea.l (a6,d0.w),a6
		move.w  a6,(word_FF500C).l
		move.b  1(a6),(byte_FF500F).l
		bra.w   loc_15FA6
loc_16300:      bsr.s   sub_16306
		bra.w   loc_15FA6

; =============== S U B R O U T I N E =======================================

sub_16306:
		lea     byte_166E6(pc), a6
		move.w  a6,(word_FF500C).l
...
loc_1631A:      clr.b   (byte_FF500F).l
		bra.w   loc_15FA6
loc_16324:      bsr.w   sub_15FC2
		move.b  d0,d1
		lsl.w   #8,d1
		bsr.w   sub_15FC2
		move.b  d0,d1
...
loc_163BE:      bsr.s   sub_163A2
		...
		sub.w   d0,4(a2,d1.w)
		bra.w   loc_15FA6
loc_16432:      movem.w (sp)+,d1
		add.w   d0,4(a2,d1.w)
		bra.w   loc_15FA6
loc_1643E:      movem.w (sp)+,d1
		add.w   d0,6(a2,d1.w)
		bra.w   loc_15FA6
loc_1644A:      movem.w (sp)+,d1
		sub.w   d0,6(a2,d1.w)
		bra.w   loc_15FA6
loc_16456:      ori.b   #$40,8(a0) 
		bra.w   loc_15FA6
loc_16460:      andi.b  #$BF,8(a0)
		bra.w   loc_15FA6
...
loc_16A16:
		...
		bcc.w   loc_16A54
		beq.w   loc_16A54
		move.w  -8(a6),((word_FFF844-$1000000)).w
		move.w  #$174,d0
		bsr.w   sub_16860
		bsr.w   sub_16E7E
		beq.w   loc_169C4
...
sub_16EA6:
		move.b  #5,((byte_FFB526-$1000000)).w
		bra.s   loc_16EB4
...
sub_16EAE:
		move.b  #9,((byte_FFB526-$1000000)).w
loc_16EB4:
		movem.l d1-a6,-(sp)
		jsr     sub_8048
		cmpi.w  #$FFFF,d0
...
loc_16F44:
		...
		cmpi.b  #$FF,d1
		bne.s   loc_16F44
		move.w  d0,((word_FFA93E-$1000000)).w
		rts
loc_16F56:
		jsr     sub_20364
		move.w  ((word_FFA93E-$1000000)).w,d0
		rts

	; End of function sub_16F1C
...
loc_17104:
		...
		st      -$16(a6)
		clr.w   ((word_FFF844-$1000000)).w
		move.b  -$1C(a6),((word_FFF844+1-$1000000)).w
		move.w  #$197,d0
		bsr.w   sub_16860
		moveq   #$A,d0
		move.l  d0,((dword_FFF900-$1000000)).w
...
sub_175DE:
		move.l  d0,-(sp)
		move.l  #unk_FF52EA,(dword_FFF006).l
		moveq   #$FFFFFFFF,d0
		bsr.s   sub_175F2
		move.l  (sp)+,d0
		rts
...
sub_175F2:
		...
		clr.w   d0
		move.b  (a0)+,d0
		move.b  d0,(byte_FFF800).l
		add.w   d0,d0
		movea.w d0,a3
		move.b  (a0)+,(byte_FFF801).l
		movea.l (dword_FFF006).l,a1
		clr.w   d0
		move.b  (byte_FFF800).l,d0
		clr.w   d1
		move.b  (byte_FFF801).l,d1
		mulu.w  d1,d0
		add.w   d0,d0
		lea     (a1,d0.w),a2
		move.l  a5,d1
...
sub_17A2E:
		...
		clr.w   (word_FFC0BE).l
		clr.w   d1
		move.b  (byte_FFF800).l,d1
		add.w   d1,d1
		clr.w   d0
		move.b  (word_FF5000+1).l,d0
		mulu.w  d1,d0
		clr.w   d3
		move.b  (word_FF5000).l,d3
		add.w   d3,d3
		moveq   #$18,d2
		and.b   (byte_FF5002).l,d2
		subq.b  #8,d2
		bcc.s   loc_17A66
		sub.w   d1,d3
		bra.s   loc_17A78
...
j_j_GetEventFlag:
		...
		jmp     (j_GetEventFlag).l

	; End of function j_j_GetEventFlag
...
loc_17C7C:
		move.l  d0,(a0)+
		dbf     d1,loc_17C7C
		move.b  ((byte_FFF808-$1000000)).w,d0
		cmpi.b  #$2E,d0 
		bne.s   loc_17CA6
		move.w  #$57,d0 
		bsr.s   j_j_GetEventFlag
		bne.s   loc_17CA4
		moveq   #$A,d0
		moveq   #$FFFFFFFF,d1
		jsr     (sub_384).l
...
sub_17F88:
		...
		jsr     (a5)
		jsr     (sub_328).l
		move.w  -6(a6),((word_FFC0BE-$1000000)).w
		movem.l (sp)+,d0-d1/d6
		rts
...
; START OF FUNCTION CHUNK FOR sub_180CA
...
; END OF FUNCTION CHUNK FOR sub_180CA
...
loc_1810C:      cmpi.b  #3,d1
		...
		jsr     (a5)
		rts
loc_1811E:      move.w  d6,-(sp)
		move.w  #$8A0,d6
		moveq   #0,d0
		jsr     (a5)
		move.w  (sp)+,d6
		rts
loc_1812C:      cmpi.w  #0,d2
		bne.s   loc_18148
		moveq   #$1E,d0
		jsr     (a4)
		move.l  d0,-(sp)
...
; START OF FUNCTION CHUNK FOR sub_18208

loc_18234:
		bra.w   sub_18074

; END OF FUNCTION CHUNK FOR sub_18208
...
loc_18276:      cmpi.w  #$12,d1
		...
		bsr.w   sub_18046
		rts
loc_1828E:      cmpi.w  #$17,d1
		bne.s   loc_182C6
		move.w  #$366,d6
		move.w  #$51,d0 
		bsr.w   j_j_GetEventFlag
		bne.s   loc_182A8
		moveq   #0,d0
		jsr     (a5)
		bra.s   return_182C4
...
loc_182E6:      cmpi.w  #$19,d1
		...
		move.w  #$55,d0 
		bsr.w   sub_17C5E
loc_1830A:      moveq   #1,d0
		jsr     (a5)
		rts
loc_18310:      move.w  #$36E,d6
		cmpi.w  #$C,d1
		bne.w   sub_18480
		cmpi.w  #9,d2
		bne.s   loc_18360
...
loc_183D0:
	...
	; End of function sub_183CE


; START OF FUNCTION CHUNK FOR sub_183CE
...
sub_18480:
	...
	; End of function sub_18480


; START OF FUNCTION CHUNK FOR sub_18480
...
; END OF FUNCTION CHUNK FOR sub_18480
...
loc_18980:      cmpi.w  #2,d1
		...
		jsr     (a5)
		rts
loc_1898C:      cmpi.w  #$B,d1
		bne.s   loc_1899C
		move.w  #$3B8,d6
		moveq   #0,d0
		jsr     (a5)
		rts
loc_1899C:      cmpi.w  #$10,d1
		bne.s   loc_189C6
		moveq   #$2F,d0 
		jsr     (a4)
		clr.w   d1
...
loc_18E5C:      moveq   #6,d0
		jsr     (a5)
		rts
loc_18E62:      cmpi.w  #9,d2
		bne.s   loc_18E6E
		moveq   #1,d0
		jsr     (a5)
		rts
loc_18E6E:      cmpi.w  #$A,d2
		bne.s   loc_18E7A
		moveq   #2,d0
		jsr     (a5)
		rts
loc_18E7A:      cmpi.w  #$B,d2
		bne.s   loc_18E86
		moveq   #3,d0
		jsr     (a5)
		rts
loc_18E86:      cmpi.w  #$C,d2
		bne.s   loc_18E92
		moveq   #4,d0
		jsr     (a5)
		rts
loc_18E92:      cmpi.w  #$D,d2
		bne.s   loc_18E9E
		moveq   #5,d0
		jsr     (a5)
		rts
loc_18E9E:      cmpi.w  #$18,d1
		bne.s   loc_18ED0
		cmpi.w  #8,d2
		bne.s   loc_18EAE
		bra.w   sub_180B4
loc_18EAE:      move.w  #$47D,d6
		move.l  d0,-(sp)
		move.b  #$93,d0
		bsr.w   sub_17F64
		move.l  (sp)+,d0
...
loc_18F2E:      cmpi.w  #$E,d1
		...
		move.b  d2,-2(a6)
		rts
loc_18F5E:      move.w  #$455,d6
		bra.w   sub_180A6
loc_18F66:      move.w  #$481,d6
		cmpi.w  #$19,d1
		bne.s   loc_18F90
		move.w  #$49A,d6
		cmpi.w  #8,d2
...
loc_19008:      cmpi.w  #$B,d1
		...
		move.b  d2,-2(a6)
		rts
loc_19038:      cmpi.w  #$13,d1
		bne.s   loc_19040
		addq.w  #1,d1
loc_19040:      move.w  d1,d0
		jmp     (a5)
		cmpi.b  #$FE,d1
		beq.w   loc_1931C
		cmpi.w  #3,d1
...
loc_19084:      cmpi.w  #$11,d1
		...
		moveq   #0,d0
		jsr     (a5)
loc_190AA:      cmpi.w  #$A,d2
		bne.s   loc_190B4
		moveq   #2,d0
		jsr     (a5)
loc_190B4:      cmpi.w  #$B,d2
		bne.s   loc_190BE
		moveq   #3,d0
		jsr     (a5)
loc_190BE:      cmpi.w  #$C,d2
		bne.s   loc_190C8
		moveq   #4,d0
		jsr     (a5)
...
loc_19244:      cmpi.w  #$12,d1
		...
		jsr     (a5)
		rts
loc_19250:      cmpi.w  #$13,d1
		bne.s   loc_1925C
		moveq   #4,d0
		jsr     (a5)
		rts
loc_1925C:      cmpi.w  #$14,d1
		bne.s   loc_19274
		moveq   #$24,d0 
		jsr     (a4)
		moveq   #5,d0
...
loc_192F0:      moveq   #1,d0
		...
		move.b  d2,-2(a6)
		rts
loc_19314:      move.w  #$402,d6
		bra.w   sub_180A6
loc_1931C:      cmpi.w  #1,d2
		bne.s   loc_19348
		move.w  #$79,d0 
		bsr.w   j_j_GetEventFlag
		bne.s   loc_19348
...
loc_193A0:      cmpi.w  #$E,d1
		...
		bsr.w   sub_18046
		rts
loc_193B8:      move.w  #$43B,d6
		bra.w   sub_180A6
loc_193C0:      cmpi.w  #0,d2
		bne.s   loc_193DC
		move.w  d6,-(sp)
		move.w  #$164,d6
		moveq   #0,d0
		...
		bsr.w   sub_17C5E
		rts
loc_193DC:      move.w  d6,-(sp)
		move.w  #$8A0,d6
		moveq   #0,d0
		jsr     (a5)
		move.w  (sp)+,d6
		rts
loc_193EA:      cmpi.w  #0,d2
		bne.w   loc_1944C
		move.w  #$452,d6
		moveq   #0,d0
		jsr     (a5)
...
loc_1944C:      bra.w   sub_18074
		...
		move.b  d2,-2(a6)
		rts
loc_1947E:      cmpi.w  #2,d1
		bne.s   loc_1948A
		moveq   #1,d0
		jsr     (a5)
		rts
loc_1948A:      cmpi.w  #3,d1
		bne.s   loc_1949A
		moveq   #$1D,d0
		jsr     (a4)
		moveq   #2,d0
...
loc_196A2:      cmpi.w  #$B,d1
		...
		jmp     (a5)
		bra.s   loc_196D2
loc_196CA:      move.w  #$4F6,d6
		move.w  d1,d0
		jmp     (a5)
loc_196D2:      cmpi.w  #$C,d1
		bne.s   loc_1972A
		move.w  #$4EA,d6
		move.w  #$2A,d0 
		bsr.w   j_j_GetEventFlag
...
loc_19782:      cmpi.w  #$11,d1
		...
		move.w  (sp)+,d6
		rts
loc_197A0:      move.w  #$54,d0 
		bsr.w   j_j_GetEventFlag
		bne.s   loc_197B0
		bra.w   loc_197D4
		bra.s   loc_197D4
loc_197B0:      move.w  #$2A,d0 
		bsr.w   j_j_GetEventFlag
		bne.s   loc_197C0
		bra.w   loc_19864
		bra.s   loc_197D4
loc_197C0:      move.w  #$7C,d0 
		bsr.w   j_j_GetEventFlag
		bne.s   loc_197D0
		bra.w   loc_198F2
		bra.s   loc_197D4
loc_197D0:      bra.w   loc_1997A
loc_197D4:      cmpi.w  #4,d1
		bne.s   loc_197E4
		move.w  #$4B8,d6
		moveq   #0,d0
		jsr     (a5)
		rts
loc_197E4:      cmpi.w  #$D,d1
		bne.s   loc_197F4
		move.w  #$4BD,d6
		moveq   #0,d0
		jsr     (a5)
		rts
loc_197F4:      cmpi.w  #$E,d1
		bne.s   loc_19804
		move.w  #$4BF,d6
		moveq   #0,d0
		jsr     (a5)
		rts
loc_19804:      cmpi.w  #$15,d1
		bne.s   loc_19834
		move.w  #$4C1,d6
		move.w  #$50,d0 
		bsr.w   j_j_GetEventFlag
...
loc_19834:      cmpi.w  #$16,d1
		...
		jsr     (a5)
		rts
loc_19844:      cmpi.w  #$17,d1
		bne.s   loc_19854
		move.w  #$4D1,d6
		moveq   #0,d0
		jsr     (a5)
		rts
loc_19854:      cmpi.w  #$1B,d1
		bne.s   loc_19864
		move.w  #$4D5,d6
		moveq   #0,d0
		jsr     (a5)
		rts
loc_19864:      cmpi.w  #4,d1
		bne.s   loc_19874
		move.w  #$4B8,d6
		moveq   #1,d0
		jsr     (a5)
		rts
loc_19874:      cmpi.w  #$D,d1
		bne.s   loc_19884
		move.w  #$4BD,d6
		moveq   #1,d0
		jsr     (a5)
		rts
loc_19884:      cmpi.w  #$E,d1
		bne.s   loc_19894
		move.w  #$4BF,d6
		moveq   #1,d0
		jsr     (a5)
		rts
loc_19894:      cmpi.w  #$15,d1
		bne.s   loc_198D2
		move.w  #$4C1,d6
		move.w  #$51,d0 
		bsr.w   j_j_GetEventFlag
...
loc_198D2:      cmpi.w  #$16,d1
		...
		jsr     (a5)
		rts
loc_198E2:      cmpi.w  #$17,d1
		bne.s   loc_198F2
		move.w  #$4D1,d6
		moveq   #1,d0
		jsr     (a5)
		rts
loc_198F2:      cmpi.w  #4,d1
		bne.s   loc_19912
		move.w  #$4B8,d6
		move.w  #$6C,d0 
		bsr.w   j_j_GetEventFlag
...
loc_19912:      cmpi.w  #$D,d1
		...
		jsr     (a5)
		rts
loc_19922:      cmpi.w  #$E,d1
		bne.s   loc_19932
		move.w  #$4BF,d6
		moveq   #1,d0
		jsr     (a5)
		rts
loc_19932:      cmpi.w  #$15,d1
		bne.s   loc_1994A
		move.w  #$4C1,d6
		moveq   #6,d0
		jsr     (a5)
		...
		bsr.w   sub_17C5E
		rts
loc_1994A:      cmpi.w  #$16,d1
		bne.s   loc_1995A
		move.w  #$4CE,d6
		moveq   #2,d0
		jsr     (a5)
		rts
loc_1995A:      cmpi.w  #$17,d1
		bne.s   loc_1996A
		move.w  #$4D1,d6
		moveq   #2,d0
		jsr     (a5)
		rts
loc_1996A:      cmpi.w  #$1B,d1
		bne.s   loc_1997A
		move.w  #$4D5,d6
		moveq   #1,d0
		jsr     (a5)
		rts
loc_1997A:      cmpi.w  #4,d1
		bne.s   loc_1998A
		move.w  #$4B8,d6
		moveq   #3,d0
		jsr     (a5)
		rts
loc_1998A:      cmpi.w  #$D,d1
		bne.s   loc_1999A
		move.w  #$4BD,d6
		moveq   #1,d0
		jsr     (a5)
		rts
loc_1999A:      cmpi.w  #$E,d1
		bne.s   loc_199AA
		move.w  #$4BF,d6
		moveq   #1,d0
		jsr     (a5)
		rts
loc_199AA:      cmpi.w  #$15,d1
		bne.s   loc_19A14
		move.w  #$4C1,d6
		move.w  #$53,d0 
		bsr.w   j_j_GetEventFlag
		...
		jsr     (a5)
		bra.s   loc_199D2
loc_199CE:      moveq   #7,d0
		jsr     (a5)
loc_199D2:      moveq   #8,d0
		jsr     (a5)
		jsr     sub_18056
		beq.s   loc_19A00
		moveq   #$B,d0
...
loc_19A14:      cmpi.w  #$16,d1
		...
		jsr     (a5)
		rts
loc_19A24:      cmpi.w  #$17,d1
		bne.s   loc_19A34
		move.w  #$4D1,d6
		moveq   #3,d0
		jsr     (a5)
		rts
loc_19A34:      cmpi.w  #$1B,d1
		bne.s   loc_19A44
		move.w  #$4D5,d6
		moveq   #1,d0
		jsr     (a5)
		rts
loc_19A44:      move.w  #$49C,d6
		bra.w   sub_180A6
loc_19A4C:      cmpi.w  #3,d2
		bne.s   loc_19A84
		move.w  #$4DD,d6
		moveq   #9,d0
		jsr     (a4)
...
loc_19B3E:      cmpi.w  #2,d2
		...
		jsr     (a5)
		rts
loc_19B82:      bra.w   loc_19C74
loc_19B86:      cmpi.w  #0,d2
		bne.s   loc_19BA8
		move.l  d0,-(sp)
		move.b  #$8B,d0
		bsr.w   sub_17F64
...
loc_19E2E:      move.w  #$534,d6
		...
		jsr     (a5)
		bra.s   loc_19E9C
loc_19E62:      move.w  #$56,d0 
		bsr.w   j_j_GetEventFlag
		bne.s   loc_19E72
		moveq   #0,d0
		jsr     (a5)
		bra.s   loc_19E76
loc_19E72:      moveq   #7,d0
		jsr     (a5)
loc_19E76:      jsr     sub_18056
		beq.s   loc_19E90
		moveq   #2,d0
		jsr     (a5)
		moveq   #3,d0
		...
		bsr.w   sub_17C5E
		bra.s   loc_19E9C
loc_19E90:      moveq   #1,d0
		jsr     (a5)
		move.w  #$56,d0 
		bsr.w   sub_17C5E
loc_19E9C:      bra.s   loc_19EAA
loc_19E9E:      moveq   #4,d0
		jsr     (a5)
		move.w  #$76,d0 
		bsr.w   sub_17C5E
loc_19EAA:      bra.s   loc_19EC4
loc_19EAC:      moveq   #5,d0
		jsr     (a5)
		moveq   #6,d0
		jsr     (a5)
		move.w  #$54,d0 
...
loc_19F86:      cmpi.w  #5,d1
		...
		move.w  (sp)+,d6
		rts
loc_19FB2:      move.w  #$7A,d0 
		bsr.w   j_j_GetEventFlag
		bne.s   loc_19FC2
		moveq   #0,d0
		jsr     (a5)
		bra.s   loc_19FC6
loc_19FC2:      moveq   #$C,d0
		jsr     (a5)
...
loc_1A0A6:      move.w  #$1F,d0
		...
		jsr     (a5)
		bra.s   loc_1A0E4
loc_1A0C0:      move.w  #$55,d0 
		bsr.w   j_j_GetEventFlag
		bne.s   loc_1A0D0
		moveq   #1,d0
		jsr     (a5)
		bra.s   loc_1A0E4
loc_1A0D0:      moveq   #0,d0
		jsr     (a5)
		move.w  #$7D,d0 
		bsr.w   sub_17C5E
		move.w  #$6F,d0 
...
loc_1A536:      cmpi.w  #4,d1
		...
		jsr     (a5)
		rts
loc_1A54A:      cmpi.w  #5,d1
		bne.s   loc_1A556
		moveq   #4,d0
		jsr     (a5)
		rts
loc_1A556:      cmpi.w  #6,d1
		bne.s   loc_1A562
		moveq   #5,d0
		jsr     (a5)
		rts
loc_1A562:      cmpi.w  #$A,d1
		bne.s   loc_1A576
		moveq   #6,d0
		jsr     (a5)
		move.w  #$4F,d0 
...
loc_1A5A2:      cmpi.w  #9,d1
		...
		jsr     (a5)
		rts
loc_1A5B2:      cmpi.w  #$B,d1
		bne.s   loc_1A5C2
		move.w  #$683,d6
		moveq   #0,d0
		jsr     (a5)
		rts
loc_1A5C2:      move.w  #$673,d6
		bra.w   sub_180A6
		cmpi.b  #$FF,d1
		beq.w   loc_1A630
		cmpi.b  #$FE,d1
		...
		jsr     (a5)
		rts
loc_1A5F2:      move.w  #$673,d6
		bra.w   sub_180A6
loc_1A5FA:      cmpi.w  #0,d2
		bne.s   loc_1A622
		move.l  d0,-(sp)
		move.b  #$16,d0
		bsr.w   sub_17F64
		...
		bsr.w   sub_17C5E
		rts
loc_1A622:      move.w  d6,-(sp)
		move.w  #$8A0,d6
		moveq   #0,d0
		jsr     (a5)
		move.w  (sp)+,d6
		rts
loc_1A630:      cmpi.w  #0,d2
		bne.s   loc_1A680
		move.l  d0,-(sp)
		move.b  #$16,d0
		bsr.w   sub_17F64
...
loc_1AAD0:      cmpi.w  #$16,d1
		...
		jsr     (a5)
		rts
loc_1AAE4:      move.w  #$6B8,d6
		bra.w   sub_180A6
loc_1AAEC:      cmpi.w  #0,d2
		bne.s   loc_1AB58
		move.l  d0,-(sp)
		move.b  #$9B,d0
		bsr.w   sub_17F64
...
loc_1ABE8:      move.w  #$6EF,d6
		...
		bsr.w   sub_17C5E
		rts
loc_1AC1E:      move.w  d6,-(sp)
		move.w  #$8A0,d6
		moveq   #0,d0
		jsr     (a5)
		move.w  (sp)+,d6
		rts
loc_1AC2C:      cmpi.w  #0,d2
		bne.s   loc_1AC72
		move.w  #$53,d0 
		bsr.w   j_j_GetEventFlag
		bne.s   loc_1AC72
...
loc_1AF62:      cmpi.w  #$1B,d1
		...
		bsr.w   sub_17C5E
		rts
loc_1AF9C:      move.w  d6,-(sp)
		move.w  #$8A0,d6
		moveq   #0,d0
		jsr     (a5)
		move.w  (sp)+,d6
		rts
loc_1AFAA:      move.w  #$739,d6
		cmpi.w  #0,d2
		bne.s   loc_1AFCA
		moveq   #$17,d0
		jsr     (a4)
...
loc_1B190:      cmpi.w  #$1A,d1
		...
		bsr.w   sub_17C5E
		rts
loc_1B1BE:      move.w  #$73E,d6
		bra.w   sub_180A6
loc_1B1C6:      cmpi.w  #0,d2
		bne.s   loc_1B1F6
		move.l  d0,-(sp)
		move.b  #9,d0
		bsr.w   sub_17F64
...
loc_1B60A:      cmpi.w  #$1A,d1
		...
		jsr     (a5)
		rts
loc_1B61A:      move.w  #$582,d6
		bra.w   sub_180A6
loc_1B622:      cmpi.w  #0,d2
		bne.s   loc_1B66A
		moveq   #$2E,d0 
		jsr     (a4)
		move.l  d0,-(sp)
...
loc_1B6B2:      cmpi.w  #2,d2
		...
		jsr     (a5)
		rts
loc_1B6DC:      move.w  d6,-(sp)
		move.w  #$8A0,d6
		moveq   #0,d0
		jsr     (a5)
		move.w  (sp)+,d6
		rts
loc_1B6EA:      cmpi.b  #$FF,d1
		beq.w   loc_1B84A
		cmpi.w  #$10,d1
		bne.s   loc_1B71C
		moveq   #$2F,d0 
...
loc_1B822:      cmpi.w  #$1B,d1
		...
		jsr     (a5)
		rts
loc_1B842:      move.w  #$5C3,d6
		bra.w   sub_180A6
loc_1B84A:      cmpi.w  #0,d2
		bne.s   loc_1B892
		moveq   #$2E,d0 
		jsr     (a4)
		move.l  d0,-(sp)
...
loc_1B988:      cmpi.w  #3,d2
		...
		jsr     (a5)
		rts
loc_1B9A0:      cmpi.w  #4,d2
		bne.s   loc_1B9A8
		rts
loc_1B9A8:      cmpi.w  #5,d2
		bne.s   loc_1B9B0
		rts
...
loc_1BC3A:      moveq   #1,d0
		...
		jsr     (a5)
		bra.s   loc_1BC62
loc_1BC4E:      moveq   #4,d0
		jsr     (a5)
		move.w  #$43,d0 
		bsr.w   sub_17C5E
		move.w  #$51,d0 
		bsr.w   sub_17C5E
loc_1BC62:      bra.s   loc_1BC88
loc_1BC64:      moveq   #5,d0
		jsr     (a5)
		bsr.w   sub_18056
		bne.s   loc_1BC74
		moveq   #3,d0
...
loc_1BE9C:      cmpi.w  #$1C,d1
		...
		jsr     (a5)
		bra.s   loc_1BEE8
loc_1BEC0:      moveq   #2,d0
		jsr     (a5)
loc_1BEC4:      jsr     (sub_328).l
		moveq   #3,d0
		jsr     (a5)
		bsr.w   sub_18056
		beq.s   loc_1BEDC
...
loc_1C352:      move.w  #$51,d0 
		...
		bsr.w   sub_18046
		rts
loc_1C376:      move.w  #$5EF,d6
		bra.w   sub_180A6
loc_1C37E:      cmpi.w  #$14,d1
		bne.s   loc_1C396
		move.w  #$61E,d6
		moveq   #0,d0
		jsr     (a5)
...
loc_1C72C:      cmpi.w  #$14,d1
		...
		bsr.w   sub_17C5E
		rts
loc_1C75C:      move.w  #$826,d6
		bra.w   sub_180A6
loc_1C764:      cmpi.w  #0,d2
		bne.s   loc_1C78C
		move.l  d0,-(sp)
		move.b  #$7F,d0 
		bsr.w   sub_17F64
...
loc_1C7F0:      cmpi.w  #4,d2
		...
		jsr     (a5)
		rts
loc_1C870:      move.w  d6,-(sp)
		move.w  #$8A0,d6
		moveq   #0,d0
		jsr     (a5)
		move.w  (sp)+,d6
		rts
loc_1C87E:      cmpi.w  #1,d2
		bne.s   loc_1C89A
		move.w  d6,-(sp)
		move.w  #$857,d6
		moveq   #0,d0
...
loc_1CAE2:      cmpi.w  #$1512,d2
		...
		bsr.w   sub_17C5E
		rts
loc_1CAF2:      bra.w   sub_1808A
loc_1CAF6:      cmpi.w  #0,d2
		bne.s   loc_1CB1A
		moveq   #$30,d0 
		jsr     (a4)
		move.l  d0,-(sp)
...
loc_1D300:      cmpi.w  #3,d2
		...
		jsr     (a5)
		rts
loc_1D310:      bra.w   sub_180B4
loc_1D314:      cmpi.w  #0,d2
		bne.s   loc_1D352
		move.w  #$52,d0 
		bsr.w   j_j_GetEventFlag
		bne.s   loc_1D352
		...
		bsr.w   sub_17C5E
		rts
loc_1D352:      bra.w   sub_18074
loc_1D356:      move.w  d0,-(sp)
		move.w  d1,-(sp)
		move.l  a0,-(sp)
		lea     unk_1D37E(pc), a0
loc_1D360:      clr.b   d1
...
loc_1DB04:      clr.l   (a0)+
		...
		move.w  #$78,d0 
		jsr     (sub_244).l
		move.b  #1,((unk_FFC141-$1000000)).w
		jsr     sub_203F8
		clr.w   d0
		moveq   #$E,d7
loc_1DB4C:      movem.w d0/d7,-(sp)
		move.b  d0,((unk_FFCBB3-$1000000)).w
		clr.b   ((unk_FFB5BC-$1000000)).w
		jsr     sub_203FC
		move.w  d0,-(sp)
		jsr     sub_124024
		move.w  #$A,d0
		...
		jsr     (sub_290).w
		jsr     (sub_260).w
		movea.l (off_C0018).l,a0
		lea     (dword_FF0080).l,a1
		lea     (RAM_START).l,a2
		moveq   #$3F,d0 
loc_1DC38:      move.w  (a0)+,(a1)+
		move.w  #0,(a2)+
		dbf     d0,loc_1DC38
		lea     (unk_FFD000).l,a0
		move.w  #$3FF,d7
loc_1DC4C:      clr.l   (a0)+
		...
		lea     (RAM_START).l,a2
		moveq   #7,d7
loc_1DC9C:      move.l  (a0)+,d0
		move.l  d0,(a1)+
		move.l  d0,(a2)+
		dbf     d7,loc_1DC9C
		movea.l (off_C0000).l,a0
		lea     (sub_8000).l,a1
		move.w  #$900,d0
		move.w  #2,d1
		jsr     (sub_294).l
		movea.l (off_C0010).l,a0
		lea     ($9200).l,a1
		move.w  #$400,d0
		move.w  #2,d1
		jsr     (sub_294).l
		movea.l (off_C001C).l,a0
		lea     (loc_9A00).l,a1
		move.w  #$600,d0
		move.w  #2,d1
		jsr     (sub_294).l
		movea.l (off_C0014).l,a0
		lea     (loc_6000).w,a1
		move.w  #$600,d0
		move.w  #2,d1
		jsr     (sub_294).l
...
loc_1DDBA:      subq.w  #2,(a0)
		...
		move.w  #$21C,d0
		jsr     (sub_244).l
		move.b  #$B,(byte_FF0EBC).l
		move.b  #5,(byte_FF0EB9).l
		move.b  #2,(byte_FF0EB7).l
		clr.b   (byte_FF0EBA).l
		move.b  (byte_FF0EB9).l,(byte_FF0EBB).l
		moveq   #$5A,d0 
		...
		jmp     (a0)
off_1DF28:      dc.l unk_1DF68          ; tiles ?
		dc.l byte_1DF8B
		dc.l byte_1DFCA
		dc.l unk_1E014
		dc.l byte_1E04A
...
sub_1EFE0:
		move.b  #$C0,(byte_FFF809).l
		clr.w   (word_FFF8DC).l
		clr.w   (word_FFF8DA).l
		rts

	; End of function sub_1EFE0
...
loc_1F054:
	...
	; End of function DecompressText
